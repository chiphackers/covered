...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} parse\_\-and\_\-score\_\-dumpfile (char $\ast$ {\em top}, char $\ast$ {\em db}, char $\ast$ {\em vcd})}\label{parse_8h_a1}
