...
\item[Parameters:]
\begin{description}
\item[{\em argc}]Number of arguments specified in argv parameter list. \item[{\em argv}]List of arguments passed to this process from the command-line. \end{description}
\end{Desc}
\begin{Desc}
\item[Returns:]Returns 0 to indicate a successful return; otherwise, returns a non-zero value.\end{Desc}
