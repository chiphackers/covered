...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void define\_\-macro (const char $\ast$ {\em name}, const char $\ast$ {\em value})}\label{score_8c_a12}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} read\_\-command\_\-file (char $\ast$ {\em cmd\_\-file}, char $\ast$$\ast$$\ast$ {\em arg\_\-list}, int $\ast$ {\em arg\_\-num})}\label{score_8c_a14}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} score\_\-parse\_\-args (int {\em argc}, int {\em last\_\-arg}, char $\ast$$\ast$ {\em argv})}\label{score_8c_a15}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void score\_\-usage ()}\label{score_8c_a13}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} {\bf instance\_\-specified} = FALSE}\label{score_8c_a6}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}char$\ast$ {\bf ppfilename} = NULL}\label{score_8c_a5}


Name of preprocessor filename to use \index{score.c@{score.c}!timestep_update@{timestep\_\-update}}
\index{timestep_update@{timestep\_\-update}!score.c@{score.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int {\bf timestep\_\-update} = 0}\label{score_8c_a7}


Specifies timestep increment to display current time \index{score.c@{score.c}!top_instance@{top\_\-instance}}
\index{top_instance@{top\_\-instance}!score.c@{score.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}char$\ast$ {\bf top\_\-instance} = NULL}\label{score_8c_a1}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}char$\ast$ {\bf top\_\-module} = NULL}\label{score_8c_a0}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf str\_\-link}$\ast$ {\bf use\_\-files\_\-head} ()}\label{score_8c_a10}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}char {\bf user\_\-msg}[USER\_\-MSG\_\-LENGTH] ()}\label{score_8c_a11}
