...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int command\_\-score (int {\em argc}, char $\ast$$\ast$ {\em argv})}\label{score_8c_a7}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} read\_\-command\_\-file (char $\ast$ {\em cmd\_\-file}, char $\ast$$\ast$ {\em arg\_\-list}, int $\ast$ {\em arg\_\-num})}\label{score_8c_a5}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} score\_\-parse\_\-args (int {\em argc}, char $\ast$$\ast$ {\em argv})}\label{score_8c_a6}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void score\_\-usage ()}\label{score_8c_a4}


Displays usage information for score command. 

\subsection{Variable Documentation}
\index{score.c@{score.c}!largest_malloc_size@{largest\_\-malloc\_\-size}}
