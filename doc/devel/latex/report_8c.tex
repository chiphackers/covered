...
\begin{description}
\item[
{\em root}]Pointer to root of instance tree to search.
...
\begin{description}
\item[
{\em head}]Pointer to head of module list to search.
...
\begin{description}
\item[
{\em ofile}]Pointer to output stream to display report information to.
...
\begin{description}
\item[
{\em metrics}]Specified metrics to calculate coverage for.
