...
\item 
unsigned int {\bf report\_\-comb\_\-depth} = 0
\item 
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}unsigned int report\_\-comb\_\-depth = 0}\label{report_8c_a7}


If set to a non-zero value, causes Covered to only generate combinational logic report information for depths up to the number specified. If set to 0, all combinational logic is evaluated. \index{report.c@{report.c}!report_combination@{report\_\-combination}}
