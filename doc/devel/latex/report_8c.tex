...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int command\_\-report (int {\em argc}, int {\em last\_\-arg}, char $\ast$$\ast$ {\em argv})}\label{report_8c_a18}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void report\_\-gather\_\-instance\_\-stats ({\bf mod\_\-inst} $\ast$ {\em root})}\label{report_8c_a14}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void report\_\-gather\_\-module\_\-stats ({\bf mod\_\-link} $\ast$ {\em head})}\label{report_8c_a15}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void report\_\-generate (FILE $\ast$ {\em ofile})}\label{report_8c_a17}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} report\_\-parse\_\-args (int {\em argc}, int {\em last\_\-arg}, char $\ast$$\ast$ {\em argv})}\label{report_8c_a13}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void report\_\-parse\_\-metrics (char $\ast$ {\em metrics})}\label{report_8c_a12}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void report\_\-print\_\-header (FILE $\ast$ {\em ofile})}\label{report_8c_a16}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void report\_\-usage ()}\label{report_8c_a11}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}char$\ast$ input\_\-db = NULL}\label{report_8c_a8}


\index{report.c@{report.c}!instance_root@{instance\_\-root}}
\index{instance_root@{instance\_\-root}!report.c@{report.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf mod\_\-inst}$\ast$ instance\_\-root}\label{report_8c_a9}


\index{report.c@{report.c}!mod_head@{mod\_\-head}}
\index{mod_head@{mod\_\-head}!report.c@{report.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf mod\_\-link}$\ast$ mod\_\-head}\label{report_8c_a10}


\index{report.c@{report.c}!output_file@{output\_\-file}}
\index{output_file@{output\_\-file}!report.c@{report.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}char$\ast$ output\_\-file = NULL}\label{report_8c_a7}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}unsigned int report\_\-comb\_\-depth = REPORT\_\-SUMMARY}\label{report_8c_a6}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} report\_\-covered = FALSE}\label{report_8c_a5}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} report\_\-instance = FALSE}\label{report_8c_a4}
