...
Performs report command functionality. \index{report.c@{report.c}!report_gather_stats@{report\_\-gather\_\-stats}}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} report\_\-parse\_\-args (int {\em argc}, int {\em last\_\-arg}, char $\ast$$\ast$ {\em argv})}\label{report_8c_a11}
