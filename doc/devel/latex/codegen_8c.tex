...
line}]Specifies last line number to generate. \item[{\em 
parent\_\-op}]Operation of parent. If our op is the same, no surrounding parenthesis is needed.\end{description}
\end{Desc}
\begin{Desc}
\item[Returns: ]\par
