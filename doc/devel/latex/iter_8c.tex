...
\item[Parameters:]
\begin{description}
\item[{\em si}]Pointer to statement iterator to transform. \item[{\em skip}]Specifies if we should skip to the next statement header.\end{description}
\end{Desc}
...
\item[Parameters:]
\begin{description}
\item[{\em si}]Pointer to statement iterator to transform.\end{description}
\end{Desc}
...
\item[Parameters:]
\begin{description}
\item[{\em si}]Pointer to statement iterator to advance.\end{description}
\end{Desc}
\begin{Desc}
\item[Returns:]Returns pointer to next statement link.\end{Desc}
...
\item[Parameters:]
\begin{description}
\item[{\em si}]Pointer to statement iterator to reset. \item[{\em start}]Specifies link to start iterating through (can be head or tail).\end{description}
\end{Desc}
...
\item[Parameters:]
\begin{description}
\item[{\em si}]Pointer to statement iterator to reverse.\end{description}
\end{Desc}
