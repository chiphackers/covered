...
\end{Desc}
Outputs specified error message string to standard output and increments error count. \index{parser_misc.c@{parser\_\-misc.c}!VLwarn@{VLwarn}}
...
\end{Desc}
Outputs specified warning message string to standard output and increments warning count. \index{parser_misc.c@{parser\_\-misc.c}!VLwrap@{VLwrap}}
...
Counts the number of errors found during the parsing process. \index{parser_misc.c@{parser\_\-misc.c}!user_msg@{user\_\-msg}}
\index{user_msg@{user\_\-msg}!parser_misc.c@{parser\_\-misc.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}char {\bf user\_\-msg}[USER\_\-MSG\_\-LENGTH] ()}\label{parser__misc_8c_a0}


Holds some output that will be displayed via the print\_\-output command. This is created globally so that memory does not need to be reallocated for each function that wishes to use it. \index{parser_misc.c@{parser\_\-misc.c}!warn_count@{warn\_\-count}}
