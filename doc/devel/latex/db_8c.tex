...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-add\_\-declared\_\-param (char $\ast$ {\em name}, {\bf expression} $\ast$ {\em expr})}\label{db_8c_a28}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-add\_\-defparam (char $\ast$ {\em name}, {\bf expression} $\ast$ {\em expr})}\label{db_8c_a31}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-add\_\-expression ({\bf expression} $\ast$ {\em root})}\label{db_8c_a35}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-add\_\-instance (char $\ast$ {\em scope}, char $\ast$ {\em modname})}\label{db_8c_a25}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-add\_\-module (char $\ast$ {\em name}, char $\ast$ {\em file})}\label{db_8c_a26}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-add\_\-override\_\-param (char $\ast$ {\em inst\_\-name}, {\bf expression} $\ast$ {\em expr})}\label{db_8c_a29}
...
\end{Desc}
Creates override parameter and stores this in the current module as well as all associated instances. \index{db.c@{db.c}!db_add_signal@{db\_\-add\_\-signal}}
\index{db_add_signal@{db\_\-add\_\-signal}!db.c@{db.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-add\_\-signal (char $\ast$ {\em name}, {\bf static\_\-expr} $\ast$ {\em left}, {\bf static\_\-expr} $\ast$ {\em right})}\label{db_8c_a32}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-add\_\-statement ({\bf statement} $\ast$ {\em stmt}, {\bf statement} $\ast$ {\em start})}\label{db_8c_a37}
...
\end{Desc}
Adds the specified statement tree to the tail of the current module's statement list. The start statement is specified to avoid infinite looping. \index{db.c@{db.c}!db_add_vector_param@{db\_\-add\_\-vector\_\-param}}
\index{db_add_vector_param@{db\_\-add\_\-vector\_\-param}!db.c@{db.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-add\_\-vector\_\-param ({\bf signal} $\ast$ {\em sig}, {\bf expression} $\ast$ {\em parm\_\-exp}, int {\em type})}\label{db_8c_a30}
...
\end{Desc}
Creates a vector parameter for the specified signal or expression with the specified parameter expression. This function is called by the parser. \index{db.c@{db.c}!db_assign_symbol@{db\_\-assign\_\-symbol}}
\index{db_assign_symbol@{db\_\-assign\_\-symbol}!db.c@{db.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-assign\_\-symbol (char $\ast$ {\em name}, char $\ast$ {\em symbol}, int {\em msb}, int {\em lsb})}\label{db_8c_a45}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-connect\_\-statement\_\-false ({\bf statement} $\ast$ {\em stmt}, {\bf statement} $\ast$ {\em next\_\-false})}\label{db_8c_a40}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-connect\_\-statement\_\-true ({\bf statement} $\ast$ {\em stmt}, {\bf statement} $\ast$ {\em next\_\-true})}\label{db_8c_a39}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf expression}$\ast$ db\_\-create\_\-expression ({\bf expression} $\ast$ {\em right}, {\bf expression} $\ast$ {\em left}, int {\em op}, int {\em line}, char $\ast$ {\em sig\_\-name})}\label{db_8c_a34}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf statement}$\ast$ db\_\-create\_\-statement ({\bf expression} $\ast$ {\em exp})}\label{db_8c_a36}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-do\_\-timestep (int {\em time})}\label{db_8c_a48}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-end\_\-module ()}\label{db_8c_a27}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf signal}$\ast$ db\_\-find\_\-signal (char $\ast$ {\em name})}\label{db_8c_a33}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} db\_\-read (char $\ast$ {\em file}, int {\em read\_\-mode})}\label{db_8c_a24}
...
Opens specified database file for reading. Reads in each line from the file examining its contents and creating the appropriate type to store the specified information and stores it into the appropriate internal list. If there are any problems opening the file for reading or parsing errors, returns FALSE; otherwise, returns TRUE. \index{db.c@{db.c}!db_remove_statement@{db\_\-remove\_\-statement}}
\index{db_remove_statement@{db\_\-remove\_\-statement}!db.c@{db.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-remove\_\-statement ({\bf statement} $\ast$ {\em stmt})}\label{db_8c_a38}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-set\_\-symbol\_\-string (char $\ast$ {\em sym}, char $\ast$ {\em value})}\label{db_8c_a47}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-set\_\-vcd\_\-scope (char $\ast$ {\em scope})}\label{db_8c_a43}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-statement\_\-connect ({\bf statement} $\ast$ {\em curr\_\-stmt}, {\bf statement} $\ast$ {\em next\_\-stmt})}\label{db_8c_a41}
...
\end{Desc}
Calls the statement\_\-connect function located in {\bf statement.c}{\rm (p.\,\pageref{statement_8c})} with the specified parameters. \index{db.c@{db.c}!db_statement_set_stop@{db\_\-statement\_\-set\_\-stop}}
\index{db_statement_set_stop@{db\_\-statement\_\-set\_\-stop}!db.c@{db.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-statement\_\-set\_\-stop ({\bf statement} $\ast$ {\em stmt}, {\bf statement} $\ast$ {\em post}, {\bf bool} {\em both})}\label{db_8c_a42}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-vcd\_\-upscope ()}\label{db_8c_a44}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} db\_\-write (char $\ast$ {\em file}, {\bf bool} {\em parse\_\-mode})}\label{db_8c_a23}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf mod\_\-inst}$\ast$ {\bf curr\_\-instance} = NULL}\label{db_8c_a13}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf module}$\ast$ {\bf curr\_\-module} = NULL}\label{db_8c_a16}


Pointer to the module structure for the module that is currently being parsed. \index{db.c@{db.c}!curr_sim_time@{curr\_\-sim\_\-time}}
...
This static value contains the current simulation time which is specified by the db\_\-do\_\-timestep function. It is used for calculating delay expressions in the simulation engine. \index{db.c@{db.c}!debug_mode@{debug\_\-mode}}
\index{debug_mode@{debug\_\-mode}!db.c@{db.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} {\bf debug\_\-mode} ()}\label{db_8c_a11}


If set to TRUE, causes debug information to be spewed to screen. \index{db.c@{db.c}!flag_scored@{flag\_\-scored}}
\index{flag_scored@{flag\_\-scored}!db.c@{db.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} {\bf flag\_\-scored} ()}\label{db_8c_a9}


If this flag is set to a value of 1, it indicates that the current CDD file has been scored and is available for coverage reporting (if CDD file has not been scored, errors will occur when trying to get coverage numbers). \index{db.c@{db.c}!instance_root@{instance\_\-root}}
\index{instance_root@{instance\_\-root}!db.c@{db.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf mod\_\-inst}$\ast$ {\bf instance\_\-root} ()}\label{db_8c_a1}


Pointer to root of module instance tree \index{db.c@{db.c}!last_sim_update@{last\_\-sim\_\-update}}
\index{last_sim_update@{last\_\-sim\_\-update}!db.c@{db.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int {\bf last\_\-sim\_\-update} = 0}\label{db_8c_a22}


Contains timestep value when simulation was last performed. This value is used to determine if the current timestep needs to be printed to standard output (if the -ts option is specified to the score command. \index{db.c@{db.c}!leading_hierarchy@{leading\_\-hierarchy}}
\index{leading_hierarchy@{leading\_\-hierarchy}!db.c@{db.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}char {\bf leading\_\-hierarchy}[4096] ()}\label{db_8c_a8}


This string specifies the Verilog hierarchy leading up to the DUT. This value is taken from the -i value (or is a value of '$\ast$' if the -t option is only specified). \index{db.c@{db.c}!mod_head@{mod\_\-head}}
\index{mod_head@{mod\_\-head}!db.c@{db.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf mod\_\-link}$\ast$ {\bf mod\_\-head} ()}\label{db_8c_a3}


Pointer to head element of module list \index{db.c@{db.c}!mod_tail@{mod\_\-tail}}
\index{mod_tail@{mod\_\-tail}!db.c@{db.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf mod\_\-link}$\ast$ {\bf mod\_\-tail} ()}\label{db_8c_a4}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf str\_\-link}$\ast$ {\bf modlist\_\-head} = NULL}\label{db_8c_a14}


Pointer to head of list of module names that need to be parsed yet. These names are added in the db\_\-add\_\-instance function and removed in the db\_\-end\_\-module function. \index{db.c@{db.c}!modlist_tail@{modlist\_\-tail}}
\index{modlist_tail@{modlist\_\-tail}!db.c@{db.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf str\_\-link}$\ast$ {\bf modlist\_\-tail} = NULL}\label{db_8c_a15}


Pointer to tail of list of module names that need to be parsed yet. These names are added in the db\_\-add\_\-instance function and removed in the db\_\-end\_\-module function. \index{db.c@{db.c}!no_score_head@{no\_\-score\_\-head}}
\index{no_score_head@{no\_\-score\_\-head}!db.c@{db.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf str\_\-link}$\ast$ {\bf no\_\-score\_\-head} ()}\label{db_8c_a2}


Pointer to head element of modules not-to-score list \index{db.c@{db.c}!one_instance_found@{one\_\-instance\_\-found}}
\index{one_instance_found@{one\_\-instance\_\-found}!db.c@{db.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} {\bf one\_\-instance\_\-found} ()}\label{db_8c_a7}


This flag is used to indicate if Covered was successfull in finding at least one matching instance from the VCD file. If no instances were found for the entire VCD file, the user has either not specified the -i option or has specified an incorrect path to the top-level module instance so let them know about this. \index{db.c@{db.c}!or_optab@{or\_\-optab}}
\index{or_optab@{or\_\-optab}!db.c@{db.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf nibble} {\bf or\_\-optab}[16] ()}\label{db_8c_a5}


OR operation table \index{db.c@{db.c}!postsim_timestep_tab@{postsim\_\-timestep\_\-tab}}
\index{postsim_timestep_tab@{postsim\_\-timestep\_\-tab}!db.c@{db.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf symtable}$\ast$ {\bf postsim\_\-timestep\_\-tab} = NULL}\label{db_8c_a19}


Pointer to the post-simulation timestep table tree structure. This tree contains copies of the VCD symbol table tree entries that are to be evaluated just after simulation for a particular timestep. \index{db.c@{db.c}!presim_timestep_tab@{presim\_\-timestep\_\-tab}}
\index{presim_timestep_tab@{presim\_\-timestep\_\-tab}!db.c@{db.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf symtable}$\ast$ {\bf presim\_\-timestep\_\-tab} = NULL}\label{db_8c_a18}


Pointer to the pre-simulation timestep table tree structure. This tree contains copies of the VCD symbol table tree entries that are to be evaluated just prior to simulation for a particular timestep. \index{db.c@{db.c}!timestep_update@{timestep\_\-update}}
\index{timestep_update@{timestep\_\-update}!db.c@{db.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int {\bf timestep\_\-update} ()}\label{db_8c_a10}


Specifies timestep increment to display current time \index{db.c@{db.c}!top_module@{top\_\-module}}
...
Name of top-level module to score \index{db.c@{db.c}!user_msg@{user\_\-msg}}
...
Holds some output that will be displayed via the print\_\-output command. This is created globally so that memory does not need to be reallocated for each function that wishes to use it. \index{db.c@{db.c}!vcd_symtab@{vcd\_\-symtab}}
\index{vcd_symtab@{vcd\_\-symtab}!db.c@{db.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf symtable}$\ast$ {\bf vcd\_\-symtab} = NULL}\label{db_8c_a17}
