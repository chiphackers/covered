...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf statement}$\ast$ db\_\-create\_\-statement ({\bf expression} $\ast$ {\em exp}, {\bf sig\_\-link} $\ast$$\ast$ {\em head}, {\bf sig\_\-link} $\ast$$\ast$ {\em tail})}\label{db_8c_a33}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf mod\_\-inst}$\ast$ {\bf curr\_\-instance} = NULL}\label{db_8c_a11}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf module}$\ast$ {\bf curr\_\-module} = NULL}\label{db_8c_a14}
...
This static value contains the current simulation time which is specified by the db\_\-do\_\-timestep function. It is used for calculating delay expressions in the simulation engine. \index{db.c@{db.c}!flag_scored@{flag\_\-scored}}
...
Pointer to root of module instance tree \index{db.c@{db.c}!leading_hierarchy@{leading\_\-hierarchy}}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf str\_\-link}$\ast$ {\bf modlist\_\-head} = NULL}\label{db_8c_a12}


\index{db.c@{db.c}!modlist_tail@{modlist\_\-tail}}
\index{modlist_tail@{modlist\_\-tail}!db.c@{db.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf str\_\-link}$\ast$ {\bf modlist\_\-tail} = NULL}\label{db_8c_a13}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf symtable}$\ast$ {\bf postsim\_\-timestep\_\-tab} = NULL}\label{db_8c_a17}


\index{db.c@{db.c}!presim_timestep_tab@{presim\_\-timestep\_\-tab}}
\index{presim_timestep_tab@{presim\_\-timestep\_\-tab}!db.c@{db.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf symtable}$\ast$ {\bf presim\_\-timestep\_\-tab} = NULL}\label{db_8c_a16}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf symtable}$\ast$ {\bf vcd\_\-symtab} = NULL}\label{db_8c_a15}
