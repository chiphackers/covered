...
\end{Desc}
Adds the specified statement tree to the tail of the current module's statement list. \index{db.c@{db.c}!db_add_vector_param@{db\_\-add\_\-vector\_\-param}}
\index{db_add_vector_param@{db\_\-add\_\-vector\_\-param}!db.c@{db.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-add\_\-vector\_\-param ({\bf signal} $\ast$ {\em sig}, {\bf expression} $\ast$ {\em exp}, {\bf expression} $\ast$ {\em parm\_\-exp}, int {\em type})}\label{db_8c_a23}
