...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-do\_\-timestep (int {\em time})}\label{db_8c_a32}
...
\end{Desc}
Calls the statement\_\-set\_\-stop function located in {\bf statement.c} with the specified parameter. \index{db.c@{db.c}!db_symbol_found@{db\_\-symbol\_\-found}}
\index{db_symbol_found@{db\_\-symbol\_\-found}!db.c@{db.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} db\_\-symbol\_\-found (char $\ast$ {\em symbol})}\label{db_8c_a30}
