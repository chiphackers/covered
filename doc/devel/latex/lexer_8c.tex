...
\item 
void {\bf define\_\-macro} (const char $\ast$name, const char $\ast$value, int {\bf keyword})
\item 
...
char $\ast$ {\bf yytext}
\item 
yyconst short int {\bf yy\_\-accept} [742]
\item 
yyconst int {\bf yy\_\-ec} [256]
\item 
yyconst int {\bf yy\_\-meta} [59]
\item 
yyconst short int {\bf yy\_\-base} [798]
\item 
yyconst short int {\bf yy\_\-def} [798]
\item 
yyconst short int {\bf yy\_\-nxt} [2779]
\item 
yyconst short int {\bf yy\_\-chk} [2779]
\item 
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define DEFINE\ 4}\label{lexer_8c_a60}


\index{lexer.c@{lexer.c}!ECHO@{ECHO}}
\index{ECHO@{ECHO}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define ECHO\ (void) fwrite( yytext, yyleng, 1, yyout )}\label{lexer_8c_a69}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define ERROR\_\-LINE\ 6}\label{lexer_8c_a62}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define IFDEF\_\-FALSE\ 8}\label{lexer_8c_a64}


\index{lexer.c@{lexer.c}!IFDEF_SUPR@{IFDEF\_\-SUPR}}
\index{IFDEF_SUPR@{IFDEF\_\-SUPR}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define IFDEF\_\-SUPR\ 10}\label{lexer_8c_a66}


\index{lexer.c@{lexer.c}!IFDEF_TRUE@{IFDEF\_\-TRUE}}
\index{IFDEF_TRUE@{IFDEF\_\-TRUE}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define IFDEF\_\-TRUE\ 9}\label{lexer_8c_a65}


\index{lexer.c@{lexer.c}!IGNORE_MODULE@{IGNORE\_\-MODULE}}
\index{IGNORE_MODULE@{IGNORE\_\-MODULE}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define IGNORE\_\-MODULE\ 7}\label{lexer_8c_a63}


\index{lexer.c@{lexer.c}!INCLUDE@{INCLUDE}}
\index{INCLUDE@{INCLUDE}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define INCLUDE\ 5}\label{lexer_8c_a61}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define LCOMMENT\ 1}\label{lexer_8c_a57}


\index{lexer.c@{lexer.c}!PPTIMESCALE@{PPTIMESCALE}}
\index{PPTIMESCALE@{PPTIMESCALE}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define PPTIMESCALE\ 11}\label{lexer_8c_a67}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define YY\_\-BREAK\ break;}\label{lexer_8c_a75}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define YY\_\-DECL\ int yylex YY\_\-PROTO(( void ))}\label{lexer_8c_a74}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define YY\_\-END\_\-OF\_\-BUFFER\ 98}\label{lexer_8c_a48}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define YY\_\-EXIT\_\-FAILURE\ 2}\label{lexer_8c_a77}


\index{lexer.c@{lexer.c}!YY_FATAL_ERROR@{YY\_\-FATAL\_\-ERROR}}
\index{YY_FATAL_ERROR@{YY\_\-FATAL\_\-ERROR}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define YY\_\-FATAL\_\-ERROR(msg)\ yy\_\-fatal\_\-error( msg )}\label{lexer_8c_a73}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define YY\_\-INPUT(buf, result, max\_\-size)}\label{lexer_8c_a70}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define YY\_\-NUM\_\-RULES\ 97}\label{lexer_8c_a47}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define YY\_\-READ\_\-BUF\_\-SIZE\ 8192}\label{lexer_8c_a68}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define YY\_\-RULE\_\-SETUP}\label{lexer_8c_a76}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define YY\_\-STACK\_\-USED\ 1}\label{lexer_8c_a56}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define YY\_\-START\_\-STACK\_\-INCR\ 25}\label{lexer_8c_a72}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define yyless(n)}\label{lexer_8c_a78}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define yyterminate()\ return YY\_\-NULL}\label{lexer_8c_a71}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}typedef struct {\bf yy\_\-buffer\_\-state}$\ast$ YY\_\-BUFFER\_\-STATE}\label{lexer_8c_a79}


\index{lexer.c@{lexer.c}!YY_CHAR@{YY\_\-CHAR}}
\index{YY_CHAR@{YY\_\-CHAR}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}typedef unsigned char YY\_\-CHAR}\label{lexer_8c_a91}


\index{lexer.c@{lexer.c}!yy_size_t@{yy\_\-size\_\-t}}
\index{yy_size_t@{yy\_\-size\_\-t}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}typedef unsigned int yy\_\-size\_\-t}\label{lexer_8c_a83}


\index{lexer.c@{lexer.c}!yy_state_type@{yy\_\-state\_\-type}}
\index{yy_state_type@{yy\_\-state\_\-type}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}typedef int yy\_\-state\_\-type}\label{lexer_8c_a92}




\subsection{Function Documentation}
\index{lexer.c@{lexer.c}!def_finish@{def\_\-finish}}
\index{def_finish@{def\_\-finish}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void def\_\-finish ()\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a141}


Completes the define addition phase. \index{lexer.c@{lexer.c}!def_lookup@{def\_\-lookup}}
\index{def_lookup@{def\_\-lookup}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}struct define\_\-t$\ast$ def\_\-lookup (const char $\ast$ {\em name})\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a150}
...
Looks up the specified define identifier in the binary tree lookup table. Returns NULL (0), if the define was not found in the lookup tree; otherwise, returns a pointer to the defined value. \index{lexer.c@{lexer.c}!def_match@{def\_\-match}}
\index{def_match@{def\_\-match}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void def\_\-match ()\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a139}


When a macro use is discovered in the source, this function is used to look up the name and emit the substitution in its place. If the name is not found, then the `name string is written out instead. \index{lexer.c@{lexer.c}!def_start@{def\_\-start}}
\index{def_start@{def\_\-start}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void def\_\-start ()\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a140}


Extracts define identifier string from define directive match. \index{lexer.c@{lexer.c}!def_undefine@{def\_\-undefine}}
\index{def_undefine@{def\_\-undefine}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void def\_\-undefine ()\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a142}


Performs an undefine of an undef indentifier by searching for the matching define node and removing it from the tree. \index{lexer.c@{lexer.c}!define_macro@{define\_\-macro}}
\index{define_macro@{define\_\-macro}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void define\_\-macro (const char $\ast$ {\em name}, const char $\ast$ {\em value}, int {\em keyword})}\label{lexer_8c_a151}
...
value}]String value associated with define identifier \item[{\em 
keyword}]If set to 1, specifies that a keyword is in the value\end{description}
\end{Desc}
Stores define identifer with its value in a define node and placed in the binary search tree for quick lookup later on. \index{lexer.c@{lexer.c}!do_define@{do\_\-define}}
\index{do_define@{do\_\-define}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void do\_\-define ()\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a143}
...
Prepares define value and identifier for storage in the lookup tree and then performs the store. \index{lexer.c@{lexer.c}!do_include@{do\_\-include}}
\index{do_include@{do\_\-include}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void do\_\-include ()\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a146}


Performs the file context switch and gets everything ready for parsing the new file. \index{lexer.c@{lexer.c}!include_filename@{include\_\-filename}}
\index{include_filename@{include\_\-filename}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void include\_\-filename ()\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a145}


Adds include directive filename to file parsing stack. \index{lexer.c@{lexer.c}!is_defined@{is\_\-defined}}
\index{is_defined@{is\_\-defined}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int is\_\-defined (const char $\ast$ {\em name})\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a144}
...
Checks lookup table to see if specified define identifier has been previously defined. \index{lexer.c@{lexer.c}!reset_lexer@{reset\_\-lexer}}
\index{reset_lexer@{reset\_\-lexer}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void reset\_\-lexer (FILE $\ast$ {\em out}, {\bf str\_\-link} $\ast$ {\em file\_\-list\_\-head})}\label{lexer_8c_a152}


\index{lexer.c@{lexer.c}!YY_PROTO@{YY\_\-PROTO}}
\index{YY_PROTO@{YY\_\-PROTO}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void yy\_\-push\_\-state YY\_\-PROTO ((int new\_\-state))\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a149}


\index{lexer.c@{lexer.c}!YY_PROTO@{YY\_\-PROTO}}
\index{YY_PROTO@{YY\_\-PROTO}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void yyunput YY\_\-PROTO ((int c, char $\ast$buf\_\-ptr))\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a148}
...
\index{lexer.c@{lexer.c}!yywrap@{yywrap}}
\index{yywrap@{yywrap}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int yywrap ()\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a147}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int comment\_\-enter\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a108}


Contains state before entering comment block. \index{lexer.c@{lexer.c}!def_name@{def\_\-name}}
\index{def_name@{def\_\-name}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}char def\_\-name[256]\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a124}


Holds current define identifier string. \index{lexer.c@{lexer.c}!def_table@{def\_\-table}}
\index{def_table@{def\_\-table}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}struct define\_\-t$\ast$ def\_\-table = 0\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a123}


Define table. \index{lexer.c@{lexer.c}!error_msg@{error\_\-msg}}
\index{error_msg@{error\_\-msg}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}char error\_\-msg[500]\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a107}


Contains error message if something wrong is found. \index{lexer.c@{lexer.c}!file@{file}}
\index{file@{file}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}FILE$\ast$ file}\label{lexer_8c_a121}


\index{lexer.c@{lexer.c}!filelist_curr@{filelist\_\-curr}}
\index{filelist_curr@{filelist\_\-curr}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf str\_\-link}$\ast$ filelist\_\-curr = 0\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a110}


\index{lexer.c@{lexer.c}!filelist_head@{filelist\_\-head}}
\index{filelist_head@{filelist\_\-head}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf str\_\-link}$\ast$ filelist\_\-head = 0\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a109}


\index{lexer.c@{lexer.c}!inc_paths_head@{inc\_\-paths\_\-head}}
\index{inc_paths_head@{inc\_\-paths\_\-head}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf str\_\-link}$\ast$ inc\_\-paths\_\-head ()}\label{lexer_8c_a106}


Pointer to head element of include paths list \index{lexer.c@{lexer.c}!istack@{istack}}
\index{istack@{istack}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}struct {\bf include\_\-stack\_\-t}$\ast$ istack = 0\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a114}


\index{lexer.c@{lexer.c}!last_keyword@{last\_\-keyword}}
\index{last_keyword@{last\_\-keyword}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int last\_\-keyword = 0\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a111}


\index{lexer.c@{lexer.c}!len@{len}}
\index{len@{len}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int len}\label{lexer_8c_a122}


\index{lexer.c@{lexer.c}!modlist_head@{modlist\_\-head}}
\index{modlist_head@{modlist\_\-head}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf str\_\-link}$\ast$ modlist\_\-head}\label{lexer_8c_a112}


\index{lexer.c@{lexer.c}!modlist_tail@{modlist\_\-tail}}
\index{modlist_tail@{modlist\_\-tail}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf str\_\-link}$\ast$ modlist\_\-tail}\label{lexer_8c_a113}


\index{lexer.c@{lexer.c}!size@{size}}
\index{size@{size}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf yy\_\-size\_\-t} size}\label{lexer_8c_a120}


\index{lexer.c@{lexer.c}!standby@{standby}}
\index{standby@{standby}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}struct {\bf include\_\-stack\_\-t}$\ast$ standby = 0\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a115}


\index{lexer.c@{lexer.c}!yy_accept@{yy\_\-accept}}
\index{yy_accept@{yy\_\-accept}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}yyconst short int yy\_\-accept[742]\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a94}


\index{lexer.c@{lexer.c}!yy_base@{yy\_\-base}}
\index{yy_base@{yy\_\-base}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}yyconst short int yy\_\-base[798]\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a97}


\index{lexer.c@{lexer.c}!yy_bp@{yy\_\-bp}}
\index{yy_bp@{yy\_\-bp}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}register char$\ast$ yy\_\-bp}\label{lexer_8c_a119}


\index{lexer.c@{lexer.c}!yy_c_buf_p@{yy\_\-c\_\-buf\_\-p}}
\index{yy_c_buf_p@{yy\_\-c\_\-buf\_\-p}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}char$\ast$ yy\_\-c\_\-buf\_\-p = (char $\ast$) 0\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a87}


\index{lexer.c@{lexer.c}!yy_chk@{yy\_\-chk}}
\index{yy_chk@{yy\_\-chk}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}yyconst short int yy\_\-chk[2779]\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a100}


\index{lexer.c@{lexer.c}!yy_current_buffer@{yy\_\-current\_\-buffer}}
\index{yy_current_buffer@{yy\_\-current\_\-buffer}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf YY\_\-BUFFER\_\-STATE} yy\_\-current\_\-buffer = 0\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a84}


\index{lexer.c@{lexer.c}!yy_def@{yy\_\-def}}
\index{yy_def@{yy\_\-def}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}yyconst short int yy\_\-def[798]\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a98}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int yy\_\-did\_\-buffer\_\-switch\_\-on\_\-eof\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a90}


\index{lexer.c@{lexer.c}!yy_ec@{yy\_\-ec}}
\index{yy_ec@{yy\_\-ec}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}yyconst int yy\_\-ec[256]\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a95}


\index{lexer.c@{lexer.c}!yy_hold_char@{yy\_\-hold\_\-char}}
\index{yy_hold_char@{yy\_\-hold\_\-char}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}char yy\_\-hold\_\-char\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a85}


\index{lexer.c@{lexer.c}!yy_init@{yy\_\-init}}
\index{yy_init@{yy\_\-init}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int yy\_\-init = 1\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a88}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}char$\ast$ yy\_\-last\_\-accepting\_\-cpos\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a102}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf yy\_\-state\_\-type} yy\_\-last\_\-accepting\_\-state\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a101}


\index{lexer.c@{lexer.c}!yy_meta@{yy\_\-meta}}
\index{yy_meta@{yy\_\-meta}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}yyconst int yy\_\-meta[59]\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a96}
...
\footnotesize\begin{verbatim}
    {   0,
        1,    2,    3,    4,    5,    1,    1,    1,    6,    1,
        1,    1,    1,    1,    7,    1,    8,    8,    8,    1,
        1,    1,    1,    9,   10,   10,   10,   10,   11,   11,
       11,   11,   10,   12,    1,   10,    1,   10,   10,   10,
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int yy\_\-more\_\-flag = 0\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a103}


\index{lexer.c@{lexer.c}!yy_more_len@{yy\_\-more\_\-len}}
\index{yy_more_len@{yy\_\-more\_\-len}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int yy\_\-more\_\-len = 0\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a104}


\index{lexer.c@{lexer.c}!yy_n_chars@{yy\_\-n\_\-chars}}
\index{yy_n_chars@{yy\_\-n\_\-chars}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int yy\_\-n\_\-chars\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a86}


\index{lexer.c@{lexer.c}!yy_nxt@{yy\_\-nxt}}
\index{yy_nxt@{yy\_\-nxt}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}yyconst short int yy\_\-nxt[2779]\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a99}


\index{lexer.c@{lexer.c}!yy_start@{yy\_\-start}}
\index{yy_start@{yy\_\-start}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int yy\_\-start = 0\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a89}


\index{lexer.c@{lexer.c}!yy_start_stack@{yy\_\-start\_\-stack}}
\index{yy_start_stack@{yy\_\-start\_\-stack}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int$\ast$ yy\_\-start\_\-stack = 0\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a118}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int yy\_\-start\_\-stack\_\-depth = 0\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a117}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int yy\_\-start\_\-stack\_\-ptr = 0\hspace{0.3cm}{\tt  [static]}}\label{lexer_8c_a116}


\index{lexer.c@{lexer.c}!yyin@{yyin}}
\index{yyin@{yyin}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}FILE$\ast$ yyin = (FILE $\ast$) 0}\label{lexer_8c_a81}


\index{lexer.c@{lexer.c}!yyleng@{yyleng}}
\index{yyleng@{yyleng}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int yyleng}\label{lexer_8c_a80}


\index{lexer.c@{lexer.c}!yylloc@{yylloc}}
\index{yylloc@{yylloc}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}YYLTYPE yylloc}\label{lexer_8c_a105}


\index{lexer.c@{lexer.c}!yyout@{yyout}}
\index{yyout@{yyout}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}FILE $\ast$ yyout = (FILE $\ast$) 0}\label{lexer_8c_a82}


\index{lexer.c@{lexer.c}!yytext@{yytext}}
\index{yytext@{yytext}!lexer.c@{lexer.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}char$\ast$ yytext}\label{lexer_8c_a93}
