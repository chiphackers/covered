...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf inst\_\-parm} $\ast$ inst\_\-parm\_\-add (char $\ast$ {\em scope}, {\bf vector} $\ast$ {\em value}, {\bf mod\_\-parm} $\ast$ {\em mparm}, {\bf inst\_\-parm} $\ast$$\ast$ {\em head}, {\bf inst\_\-parm} $\ast$$\ast$ {\em tail})}\label{param_8c_a9}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void inst\_\-parm\_\-dealloc ({\bf inst\_\-parm} $\ast$ {\em parm}, {\bf bool} {\em recursive})}\label{param_8c_a20}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf inst\_\-parm} $\ast$ inst\_\-parm\_\-find (char $\ast$ {\em name}, {\bf inst\_\-parm} $\ast$ {\em parm})}\label{param_8c_a8}
...
\begin{description}
\item[
{\em name}]Name of parameter value to find. \item[
{\em parm}]Pointer to head of instance parameter list to search.

\end{description}
\end{Desc}
\begin{Desc}
\item[{\bf Returns: }]\par
Returns pointer to found instance parameter or NULL if instance parameter is not found.
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf mod\_\-parm} $\ast$ mod\_\-parm\_\-add (char $\ast$ {\em scope}, {\bf expression} $\ast$ {\em expr}, int {\em type}, {\bf mod\_\-parm} $\ast$$\ast$ {\em head}, {\bf mod\_\-parm} $\ast$$\ast$ {\em tail})}\label{param_8c_a6}
...
\item[
{\em scope}]Full hierarchical name of parameter value. \item[
{\em expr}]Expression tree for current module parameter. \item[
{\em type}]Specifies type of module parameter (declared/override). \item[
{\em head}]Pointer to head of module parameter list to add to. \item[
{\em tail}]Pointer to tail of module parameter list to add to.
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void mod\_\-parm\_\-dealloc ({\bf mod\_\-parm} $\ast$ {\em parm}, {\bf bool} {\em recursive})}\label{param_8c_a19}
...
\begin{description}
\item[
{\em parm}]Pointer to module parameter to remove \item[
{\em recursive}]If TRUE, removes entire module parameter list; otherwise, just remove me.
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void mod\_\-parm\_\-display ({\bf mod\_\-parm} $\ast$ {\em mparm})}\label{param_8c_a7}
...
\begin{description}
\item[
{\em mparm}]Pointer to module parameter list to display.
...
\item[
{\em name}]Name of parameter value to find. \item[
{\em parm}]Pointer to head of module parameter list to search.
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void mod\_\-parm\_\-find\_\-expr\_\-and\_\-remove ({\bf expression} $\ast$ {\em exp}, {\bf mod\_\-parm} $\ast$ {\em parm})}\label{param_8c_a5}
...
\begin{description}
\item[
{\em exp}]Pointer to expression to find and remove from lists. \item[
{\em parm}]Pointer to module parameter list to search.
...
\begin{description}
\item[
{\em name}]Name of signal to search for signal-parameter dependency \item[
{\em parm}]Pointer to head of module parameter list to search.
...
\begin{Desc}
\item[{\bf Returns: }]\par
Returns pointer to found module parameter or NULL if search was unsuccessful
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void param\_\-db\_\-write ({\bf inst\_\-parm} $\ast$ {\em iparm}, FILE $\ast$ {\em file}, char $\ast$ {\em scope})}\label{param_8c_a18}
...
\begin{description}
\item[
{\em iparm}]Pointer to instance parameter to output to file. \item[
{\em file}]Pointer to file handle to write parameter contents to. \item[
{\em scope}]Current scope of parameter to output.
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void param\_\-expr\_\-eval ({\bf expression} $\ast$ {\em expr}, {\bf inst\_\-parm} $\ast$ {\em ihead})}\label{param_8c_a13}
...
\begin{description}
\item[
{\em expr}]Current expression to evaluate. \item[
{\em ihead}]Pointer to head of current instance instance parameter list.
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void param\_\-find\_\-and\_\-set\_\-expr\_\-value ({\bf expression} $\ast$ {\em expr}, {\bf inst\_\-parm} $\ast$ {\em icurr})}\label{param_8c_a11}
...
\begin{description}
\item[
{\em expr}]Pointer to current expression to evaluate. \item[
...
\begin{Desc}
\item[{\bf Returns: }]\par
Returns a pointer to the specified value found.
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf inst\_\-parm} $\ast$ param\_\-has\_\-defparam (char $\ast$ {\em scope}, {\bf mod\_\-parm} $\ast$ {\em mparm}, {\bf inst\_\-parm} $\ast$$\ast$ {\em ihead}, {\bf inst\_\-parm} $\ast$$\ast$ {\em itail})}\label{param_8c_a15}
...
\begin{description}
\item[
{\em scope}]Full hierarchical scope of parameter to check. \item[
{\em mparm}]Pointer to module parameter to attach new instance parameter to. \item[
...
\begin{Desc}
\item[{\bf Returns: }]\par
Returns pointer to created instance parameter or NULL if one is not created.
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf inst\_\-parm} $\ast$ param\_\-has\_\-override (char $\ast$ {\em mname}, {\bf mod\_\-parm} $\ast$ {\em mparm}, {\bf inst\_\-parm} $\ast$ {\em ip\_\-head}, {\bf inst\_\-parm} $\ast$$\ast$ {\em ihead}, {\bf inst\_\-parm} $\ast$$\ast$ {\em itail})}\label{param_8c_a14}
...
\begin{description}
\item[
{\em mname}]Instance name of current module. \item[
...
\begin{Desc}
\item[{\bf Returns: }]\par
Returns a pointer to the newly created instance parameter or NULL if one is not created
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void param\_\-resolve\_\-declared (char $\ast$ {\em mscope}, {\bf mod\_\-parm} $\ast$ {\em mparm}, {\bf inst\_\-parm} $\ast$ {\em ip\_\-head}, {\bf inst\_\-parm} $\ast$$\ast$ {\em ihead}, {\bf inst\_\-parm} $\ast$$\ast$ {\em itail})}\label{param_8c_a16}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} param\_\-set\_\-sig\_\-size ({\bf signal} $\ast$ {\em sig}, {\bf inst\_\-parm} $\ast$ {\em icurr})}\label{param_8c_a12}
