...
\item[Parameters:]
\begin{description}
\item[{\em ofile}]Pointer to file to output results to. \item[{\em root}]Pointer to root node of instance tree to search through.\end{description}
\end{Desc}
...
Pointer to root of module instance tree \index{line.c@{line.c}!mod_head@{mod\_\-head}}
