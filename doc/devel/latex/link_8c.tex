...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void exp\_\-link\_\-remove ({\bf expression} $\ast$ {\em exp}, {\bf exp\_\-link} $\ast$$\ast$ {\em head}, {\bf exp\_\-link} $\ast$$\ast$ {\em tail})}\label{link_8c_a17}
