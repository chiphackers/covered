...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void bind\_\-perform (char $\ast$ {\em sig\_\-name}, {\bf expression} $\ast$ {\em exp}, {\bf module} $\ast$ {\em mod}, {\bf bool} {\em implicit\_\-allowed})}\label{binding_8c_a7}
...
\end{Desc}
Performs a binding of an expression and signal based on the name of the signal. Looks up signal name in the specified module and sets the expression and signal to point to each other. \index{binding.c@{binding.c}!bind_remove@{bind\_\-remove}}
