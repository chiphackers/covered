...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf exp\_\-link}$\ast$ exp\_\-link\_\-find ({\bf expression} $\ast$ {\em exp}, {\bf exp\_\-link} $\ast$ {\em head})}\label{link_8h_a13}
...
Iteratively searches the exp\_\-link list specified by the head exp\_\-link element. If a matching expression is found, the pointer to this element is returned. If the specified expression could not be matched, the value of NULL is returned. \index{link.h@{link.h}!exp_link_remove@{exp\_\-link\_\-remove}}
\index{exp_link_remove@{exp\_\-link\_\-remove}!link.h@{link.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void exp\_\-link\_\-remove ({\bf expression} $\ast$ {\em exp}, {\bf exp\_\-link} $\ast$$\ast$ {\em head}, {\bf exp\_\-link} $\ast$$\ast$ {\em tail})}\label{link_8h_a17}
...
\item[Parameters:]
\begin{description}
\item[{\em exp}]Pointer to expression to find and remove. \item[{\em head}]Pointer to head of expression list. \item[{\em tail}]Pointer to tail of expression list.\end{description}
\end{Desc}
Searches specified list for expression that matches the specified expression. If a match is found, remove it from the list and deallocate the link memory. \index{link.h@{link.h}!mod_link_add@{mod\_\-link\_\-add}}
\index{mod_link_add@{mod\_\-link\_\-add}!link.h@{link.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void mod\_\-link\_\-add ({\bf module} $\ast$ {\em mod}, {\bf mod\_\-link} $\ast$$\ast$ {\em head}, {\bf mod\_\-link} $\ast$$\ast$ {\em tail})}\label{link_8h_a5}
...
\item[Parameters:]
\begin{description}
\item[{\em mod}]Module to add to specified module list. \item[{\em head}]Pointer to head mod\_\-link element of list. \item[{\em tail}]Pointer to tail mod\_\-link element of list.\end{description}
\end{Desc}
...
\item[Parameters:]
\begin{description}
\item[{\em head}]Pointer to head mod\_\-link element of list.\end{description}
\end{Desc}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void mod\_\-link\_\-display ({\bf mod\_\-link} $\ast$ {\em head})}\label{link_8h_a10}
...
\item[Parameters:]
\begin{description}
\item[{\em head}]Pointer to head of mod\_\-link list.\end{description}
\end{Desc}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf mod\_\-link}$\ast$ mod\_\-link\_\-find ({\bf module} $\ast$ {\em mod}, {\bf mod\_\-link} $\ast$ {\em head})}\label{link_8h_a15}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf sig\_\-link}$\ast$ sig\_\-link\_\-find ({\bf signal} $\ast$ {\em sig}, {\bf sig\_\-link} $\ast$ {\em head})}\label{link_8h_a14}
...
Iteratively searches the sig\_\-link list specified by the head sig\_\-link element. If a matching signal is found, the pointer to this element is returned. If the specified signal could not be matched, the value of NULL is returned. \index{link.h@{link.h}!stmt_link_add_head@{stmt\_\-link\_\-add\_\-head}}
\index{stmt_link_add_head@{stmt\_\-link\_\-add\_\-head}!link.h@{link.h}}
...
\end{Desc}
Creates a new stmt\_\-link element with the value specified for stmt. Sets next pointer of element to head, sets the head element to point to the new element and (possibly) sets the tail value to the new element. \index{link.h@{link.h}!stmt_link_add_tail@{stmt\_\-link\_\-add\_\-tail}}
\index{stmt_link_add_tail@{stmt\_\-link\_\-add\_\-tail}!link.h@{link.h}}
...
\item[{\em stmt}]Pointer to statement to add to specified statement list. \item[{\em head}]Pointer to head str\_\-link element of list. \item[{\em tail}]Pointer to tail str\_\-link element of list.\end{description}
\end{Desc}
Creates a new stmt\_\-link element with the value specified for stmt. Sets next pointer of element to NULL and sets the tail value to the new element. \index{link.h@{link.h}!stmt_link_delete_list@{stmt\_\-link\_\-delete\_\-list}}
\index{stmt_link_delete_list@{stmt\_\-link\_\-delete\_\-list}!link.h@{link.h}}
...
\end{Desc}
Deletes each element of the specified list. \index{link.h@{link.h}!stmt_link_display@{stmt\_\-link\_\-display}}
\index{stmt_link_display@{stmt\_\-link\_\-display}!link.h@{link.h}}
...
\end{Desc}
Displays the string contents of the stmt\_\-link list pointed to by head to standard output. This function is mainly used for debugging purposes. \index{link.h@{link.h}!stmt_link_find@{stmt\_\-link\_\-find}}
\index{stmt_link_find@{stmt\_\-link\_\-find}!link.h@{link.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf stmt\_\-link}$\ast$ stmt\_\-link\_\-find (int {\em id}, {\bf stmt\_\-link} $\ast$ {\em head})}\label{link_8h_a12}
...
Iteratively searches the stmt\_\-link list specified by the head stmt\_\-link element. If a matching statement is found, the pointer to this element is returned. If the specified statement could not be matched, the value of NULL is returned. \index{link.h@{link.h}!str_link_add@{str\_\-link\_\-add}}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void str\_\-link\_\-delete\_\-list ({\bf str\_\-link} $\ast$ {\em head})}\label{link_8h_a18}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf str\_\-link}$\ast$ str\_\-link\_\-find (char $\ast$ {\em value}, {\bf str\_\-link} $\ast$ {\em head})}\label{link_8h_a11}
...
Iteratively searches the str\_\-link list specifed by the head str\_\-link element. If a matching string is found, the pointer to this element is returned. If the specified string could not be matched, the value of NULL is returned. \index{link.h@{link.h}!str_link_remove@{str\_\-link\_\-remove}}
\index{str_link_remove@{str\_\-link\_\-remove}!link.h@{link.h}}
