...
\item[Parameters:]
\begin{description}
\item[{\em exp}]Pointer to expression to find and remove. \item[{\em head}]Pointer to head of expression list. \item[{\em tail}]Pointer to tail of expression list. \item[{\em recursive}]If TRUE, recursively removes expression tree and expressions.\end{description}
\end{Desc}
