...
void $\ast$ {\bf malloc\_\-safe\_\-nolimit} (size\_\-t {\bf size})
\begin{CompactList}\small\item\em Performs safe malloc call without upper bound on byte allocation. \item\end{CompactList}\item 
...
\begin{CompactList}\small\item\em Creates a string containing space characters. \item\end{CompactList}\item 
void {\bf timer\_\-clear} ({\bf timer} $\ast$$\ast$tm)
\begin{CompactList}\small\item\em Clears the specified timer structure. \item\end{CompactList}\item 
void {\bf timer\_\-start} ({\bf timer} $\ast$$\ast$tm)
\begin{CompactList}\small\item\em Starts timing the specified timer structure. \item\end{CompactList}\item 
void {\bf timer\_\-stop} ({\bf timer} $\ast$$\ast$tm)
\begin{CompactList}\small\item\em Stops timing the specified timer structure. \item\end{CompactList}\end{CompactItemize}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void free\_\-safe (void $\ast$ {\em ptr})}\label{util_8h_a16}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void gen\_\-space (char $\ast$ {\em spaces}, int {\em num\_\-spaces})}\label{util_8h_a17}
...
Allocated memory like a malloc() call but performs some pre-allocation and post-allocation checks to be sure that the malloc call works properly. \index{util.h@{util.h}!malloc_safe_nolimit@{malloc\_\-safe\_\-nolimit}}
\index{malloc_safe_nolimit@{malloc\_\-safe\_\-nolimit}!util.h@{util.h}}
...
\begin{Desc}
\item[Returns:]Pointer to allocated memory.\end{Desc}
Allocated memory like a malloc() call but performs some pre-allocation and post-allocation checks to be sure that the malloc call works properly. Unlike malloc\_\-safe, there is no upper bound on the amount of memory to allocate. \index{util.h@{util.h}!print_output@{print\_\-output}}
...
\end{Desc}
Sets the global variable output\_\-suppressed to the specified value. \index{util.h@{util.h}!timer_clear@{timer\_\-clear}}
\index{timer_clear@{timer\_\-clear}!util.h@{util.h}}
...
\end{Desc}
Clears the total accumulated time in the specified timer structure. \index{util.h@{util.h}!timer_start@{timer\_\-start}}
\index{timer_start@{timer\_\-start}!util.h@{util.h}}
...
\end{Desc}
Starts the timer to start timing a segment of code. \index{util.h@{util.h}!timer_stop@{timer\_\-stop}}
\index{timer_stop@{timer\_\-stop}!util.h@{util.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void timer\_\-stop ({\bf timer} $\ast$$\ast$ {\em tm})}\label{util_8h_a20}
