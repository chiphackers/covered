...
\begin{description}
\item[{\em 
file}]Pointer to file to read \item[{\em 
line}]Read line from specified file. \item[{\em 
size}]Maximum number of characters that can be stored in line. \end{description}
\end{Desc}
\begin{Desc}
\item[Returns: ]\par
Returns the number of characters read from this line.\end{Desc}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int error\_\-count}\label{parse_8c_a5}


\index{parse.c@{parse.c}!flag_scored@{flag\_\-scored}}
\index{flag_scored@{flag\_\-scored}!parse.c@{parse.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} flag\_\-scored ()}\label{parse_8c_a6}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf str\_\-link}$\ast$ use\_\-files\_\-head}\label{parse_8c_a1}


\index{parse.c@{parse.c}!user_msg@{user\_\-msg}}
