...
Counts the number of errors found during the parsing process. \index{parse.c@{parse.c}!flag_scored@{flag\_\-scored}}
\index{flag_scored@{flag\_\-scored}!parse.c@{parse.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} {\bf flag\_\-scored} ()}\label{parse_8c_a5}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf str\_\-link}$\ast$ {\bf modlist\_\-head} ()}\label{parse_8c_a1}


Pointer to head of list of module names that need to be parsed yet. These names are added in the db\_\-add\_\-instance function and removed in the db\_\-end\_\-module function. \index{parse.c@{parse.c}!modlist_tail@{modlist\_\-tail}}
\index{modlist_tail@{modlist\_\-tail}!parse.c@{parse.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf str\_\-link}$\ast$ {\bf modlist\_\-tail} ()}\label{parse_8c_a2}


Pointer to tail of list of module names that need to be parsed yet. These names are added in the db\_\-add\_\-instance function and removed in the db\_\-end\_\-module function. \index{parse.c@{parse.c}!use_files_head@{use\_\-files\_\-head}}
\index{use_files_head@{use\_\-files\_\-head}!parse.c@{parse.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf str\_\-link}$\ast$ {\bf use\_\-files\_\-head} ()}\label{parse_8c_a0}
