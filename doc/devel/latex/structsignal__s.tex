...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf exp\_\-link}$\ast$ signal\_\-s::exp\_\-head}\label{structsignal__s_m2}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf exp\_\-link}$\ast$ signal\_\-s::exp\_\-tail}\label{structsignal__s_m3}


Tail pointer to list of expressions \index{signal_s@{signal\_\-s}!name@{name}}
\index{name@{name}!signal_s@{signal\_\-s}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}char$\ast$ signal\_\-s::name}\label{structsignal__s_m0}


Full hierarchical name of signal in design \index{signal_s@{signal\_\-s}!value@{value}}
\index{value@{value}!signal_s@{signal\_\-s}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf vector}$\ast$ signal\_\-s::value}\label{structsignal__s_m1}
