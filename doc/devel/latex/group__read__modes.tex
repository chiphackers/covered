...
When new module is read from database file, it is placed in the module list and is placed in the correct hierarchical position in the instance tree. Used when performing a MERGE command or reading after parsing source files. \index{read_modes@{read\_\-modes}!READ_MODE_REPORT_MOD_MERGE@{READ\_\-MODE\_\-REPORT\_\-MOD\_\-MERGE}}
