...
Specifies the name of the input CDD file that will be read in first. If the user does not specify an output CDD filename (i.e., no -o option is specified), the name of merge\_\-in0 will be used for merged\_\-file. \index{merge.c@{merge.c}!merge_in1@{merge\_\-in1}}
...
Specifies the name of the input CDD file that will be read in second (this data is merged into the first CDD input. \index{merge.c@{merge.c}!merged_file@{merged\_\-file}}
...
Specifies the output filename of the CDD file that contains the merged data. \index{merge.c@{merge.c}!user_msg@{user\_\-msg}}
