...
Moves the curr\_\-inst\_\-scope up one level of hierarchy. This function is called when the \$upscope {\bf keyword} {\rm (p.\,\pageref{structkeyword})} is seen in a VCD file. \index{db.h@{db.h}!db_write@{db\_\-write}}
