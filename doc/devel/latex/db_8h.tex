...
\end{Desc}
Calls the statement\_\-connect function located in {\bf statement.c}{\rm (p.\,\pageref{statement_8c})} with the specified parameters. \index{db.h@{db.h}!db_statement_set_stop@{db\_\-statement\_\-set\_\-stop}}
