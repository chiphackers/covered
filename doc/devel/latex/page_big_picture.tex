\section{Section 5.  Project \char`\"{}Big Picture\char`\"{}}\label{page_big_picture}
 \begin{Desc}
\item[{\bf Section 5.1.  Covered Big Picture}]\par
 The following diagram illustrates the various core functions of Covered and how they are integrated into the tool.
...
\begin{Desc}
\item[{\bf Section 5.2.2.  Database Manager}]\par
 {\bf TBD}
