...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf module}$\ast$ module\_\-create ()}\label{module_8c_a1}
...
Allocates memory from the heap for a module element and initializes all contents to NULL. Returns a pointer to the newly created module. \index{module.c@{module.c}!module_db_read@{module\_\-db\_\-read}}
\index{module_db_read@{module\_\-db\_\-read}!module.c@{module.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} module\_\-db\_\-read ({\bf module} $\ast$$\ast$ {\em mod}, char $\ast$$\ast$ {\em scope}, char $\ast$$\ast$ {\em line})}\label{module_8c_a4}
...
Reads the current line of the specified file and parses it for a module. Creates a new module and assigns the new module to the address specified by the mod pointer. If all is successful, returns TRUE; otherwise, returns FALSE. \index{module.c@{module.c}!module_db_write@{module\_\-db\_\-write}}
\index{module_db_write@{module\_\-db\_\-write}!module.c@{module.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} module\_\-db\_\-write ({\bf module} $\ast$ {\em mod}, char $\ast$ {\em scope}, FILE $\ast$ {\em file})}\label{module_8c_a3}
...
\end{Desc}
Initializes all contents to NULL. \index{module.c@{module.c}!module_merge@{module\_\-merge}}
\index{module_merge@{module\_\-merge}!module.c@{module.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void module\_\-merge ({\bf module} $\ast$ {\em base}, {\bf module} $\ast$ {\em in})}\label{module_8c_a2}
