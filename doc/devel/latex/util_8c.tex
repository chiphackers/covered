...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void free\_\-safe (void $\ast$ {\em ptr})}\label{util_8c_a22}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void gen\_\-space (char $\ast$ {\em spaces}, int {\em num\_\-spaces})}\label{util_8c_a23}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf str\_\-link}$\ast$ get\_\-next\_\-vfile ({\bf str\_\-link} $\ast$ {\em curr}, char $\ast$ {\em mod})}\label{util_8c_a19}
...
Allocated memory like a malloc() call but performs some pre-allocation and post-allocation checks to be sure that the malloc call works properly. \index{util.c@{util.c}!malloc_safe_nolimit@{malloc\_\-safe\_\-nolimit}}
\index{malloc_safe_nolimit@{malloc\_\-safe\_\-nolimit}!util.c@{util.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void$\ast$ malloc\_\-safe\_\-nolimit (size\_\-t {\em size})}\label{util_8c_a21}
...
\begin{Desc}
\item[Returns:]Pointer to allocated memory.\end{Desc}
Allocated memory like a malloc() call but performs some pre-allocation and post-allocation checks to be sure that the malloc call works properly. Unlike malloc\_\-safe, there is no upper bound on the amount of memory to allocate. \index{util.c@{util.c}!print_output@{print\_\-output}}
...
\end{Desc}
Extracts the highest level of hierarchy from the specified scope, returning that instance name to the value of front and the the rest of the hierarchy in the value of rest. \index{util.c@{util.c}!scope_extract_scope@{scope\_\-extract\_\-scope}}
\index{scope_extract_scope@{scope\_\-extract\_\-scope}!util.c@{util.c}}
...
\index{util.c@{util.c}!scope_local@{scope\_\-local}}
\index{scope_local@{scope\_\-local}!util.c@{util.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} scope\_\-local (char $\ast$ {\em scope})}\label{util_8c_a17}
...
\end{Desc}
Sets the global variable output\_\-suppressed to the specified value. \index{util.c@{util.c}!timer_clear@{timer\_\-clear}}
\index{timer_clear@{timer\_\-clear}!util.c@{util.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void timer\_\-clear ({\bf timer} $\ast$$\ast$ {\em tm})}\label{util_8c_a24}
...
\end{Desc}
Clears the total accumulated time in the specified timer structure. \index{util.c@{util.c}!timer_start@{timer\_\-start}}
\index{timer_start@{timer\_\-start}!util.c@{util.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void timer\_\-start ({\bf timer} $\ast$$\ast$ {\em tm})}\label{util_8c_a25}
...
\end{Desc}
Starts the timer to start timing a segment of code. \index{util.c@{util.c}!timer_stop@{timer\_\-stop}}
\index{timer_stop@{timer\_\-stop}!util.c@{util.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void timer\_\-stop ({\bf timer} $\ast$$\ast$ {\em tm})}\label{util_8c_a26}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}unsigned long {\bf curr\_\-malloc\_\-size} = 0}\label{util_8c_a2}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} {\bf debug\_\-mode}}\label{util_8c_a1}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}unsigned long {\bf largest\_\-malloc\_\-size} = 0}\label{util_8c_a3}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} {\bf output\_\-suppressed}}\label{util_8c_a0}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}char {\bf user\_\-msg}[USER\_\-MSG\_\-LENGTH]}\label{util_8c_a4}
