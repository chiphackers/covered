...
Renaming symbol table structure for convenience. \index{defines.h@{defines.h}!timer@{timer}}
\index{timer@{timer}!defines.h@{defines.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}typedef struct {\bf timer\_\-s} {\bf timer}}\label{defines_8h_a179}


Renaming timer structure for convenience. \index{defines.h@{defines.h}!tnode@{tnode}}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}enum {\bf bool}}\label{defines_8h_a182}
