...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} module\_\-db\_\-read ({\bf module} $\ast$$\ast$ {\em mod}, char $\ast$$\ast$ {\em scope}, char $\ast$$\ast$ {\em line})}\label{module_8h_a4}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} module\_\-db\_\-write ({\bf module} $\ast$ {\em mod}, char $\ast$ {\em scope}, FILE $\ast$ {\em file})}\label{module_8h_a3}
