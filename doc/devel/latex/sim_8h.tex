...
\end{Desc}
Checks STMT\_\-HEAD bit of specified statement. If this is set to 1, adds this statement to the presimulation statement queue; otherwise, it does nothing with the statement \index{sim.h@{sim.h}!sim_clear_curr_wait_signals@{sim\_\-clear\_\-curr\_\-wait\_\-signals}}
\index{sim_clear_curr_wait_signals@{sim\_\-clear\_\-curr\_\-wait\_\-signals}!sim.h@{sim.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void sim\_\-clear\_\-curr\_\-wait\_\-signals ()}\label{sim_8h_a3}


\index{sim.h@{sim.h}!sim_expr_changed@{sim\_\-expr\_\-changed}}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} sim\_\-is\_\-curr\_\-wait\_\-signal ({\bf signal} $\ast$ {\em sig})}\label{sim_8h_a4}


Searches pre-simulation queue for specified signal name. 

\index{sim.h@{sim.h}!sim_set_curr_wait_signals@{sim\_\-set\_\-curr\_\-wait\_\-signals}}
\index{sim_set_curr_wait_signals@{sim\_\-set\_\-curr\_\-wait\_\-signals}!sim.h@{sim.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void sim\_\-set\_\-curr\_\-wait\_\-signals ()}\label{sim_8h_a2}


\index{sim.h@{sim.h}!sim_simulate@{sim\_\-simulate}}
\index{sim_simulate@{sim\_\-simulate}!sim.h@{sim.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void sim\_\-simulate ()}\label{sim_8h_a6}
