...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} toggle\_\-instance\_\-summary (FILE $\ast$ {\em ofile}, {\bf mod\_\-inst} $\ast$ {\em root}, char $\ast$ {\em parent\_\-inst})}\label{toggle_8c_a6}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void toggle\_\-instance\_\-verbose (FILE $\ast$ {\em ofile}, {\bf mod\_\-inst} $\ast$ {\em root}, char $\ast$ {\em parent\_\-inst})}\label{toggle_8c_a9}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} toggle\_\-module\_\-summary (FILE $\ast$ {\em ofile}, {\bf mod\_\-link} $\ast$ {\em head})}\label{toggle_8c_a7}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void toggle\_\-module\_\-verbose (FILE $\ast$ {\em ofile}, {\bf mod\_\-link} $\ast$ {\em head})}\label{toggle_8c_a10}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf mod\_\-inst}$\ast$ {\bf instance\_\-root} ()}\label{toggle_8c_a0}


Pointer to root of module instance tree \index{toggle.c@{toggle.c}!leading_hierarchy@{leading\_\-hierarchy}}
\index{leading_hierarchy@{leading\_\-hierarchy}!toggle.c@{toggle.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}char {\bf leading\_\-hierarchy}[4096] ()}\label{toggle_8c_a4}


This string specifies the Verilog hierarchy leading up to the DUT. This value is taken from the -i value (or is a value of '$\ast$' if the -t option is only specified). \index{toggle.c@{toggle.c}!mod_head@{mod\_\-head}}
\index{mod_head@{mod\_\-head}!toggle.c@{toggle.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf mod\_\-link}$\ast$ {\bf mod\_\-head} ()}\label{toggle_8c_a1}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} {\bf report\_\-covered} ()}\label{toggle_8c_a2}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} {\bf report\_\-instance} ()}\label{toggle_8c_a3}
