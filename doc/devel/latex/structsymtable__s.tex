...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf symtable} $\ast$ symtable\_\-s::left}\label{structsymtable__s_m5}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf symtable} $\ast$ symtable\_\-s::right}\label{structsymtable__s_m4}
