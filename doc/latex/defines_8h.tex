...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}typedef struct {\bf exp\_\-link\_\-s} exp\_\-link}\label{defines_8h_a101}


\index{defines.h@{defines.h}!expression@{expression}}
\index{expression@{expression}!defines.h@{defines.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}typedef struct {\bf expression\_\-s} expression}\label{defines_8h_a99}


\index{defines.h@{defines.h}!mod_inst@{mod\_\-inst}}
\index{mod_inst@{mod\_\-inst}!defines.h@{defines.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}typedef struct {\bf mod\_\-inst\_\-s} mod\_\-inst}\label{defines_8h_a109}


\index{defines.h@{defines.h}!mod_link@{mod\_\-link}}
\index{mod_link@{mod\_\-link}!defines.h@{defines.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}typedef struct {\bf mod\_\-link\_\-s} mod\_\-link}\label{defines_8h_a104}


\index{defines.h@{defines.h}!module@{module}}
\index{module@{module}!defines.h@{defines.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}typedef struct {\bf module\_\-s} module}\label{defines_8h_a103}


\index{defines.h@{defines.h}!nibble@{nibble}}
\index{nibble@{nibble}!defines.h@{defines.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}typedef unsigned int nibble}\label{defines_8h_a96}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}typedef struct {\bf sig\_\-exp\_\-bind\_\-s} sig\_\-exp\_\-bind}\label{defines_8h_a107}


\index{defines.h@{defines.h}!sig_link@{sig\_\-link}}
\index{sig_link@{sig\_\-link}!defines.h@{defines.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}typedef struct {\bf sig\_\-link\_\-s} sig\_\-link}\label{defines_8h_a102}


\index{defines.h@{defines.h}!signal@{signal}}
\index{signal@{signal}!defines.h@{defines.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}typedef struct {\bf signal\_\-s} signal}\label{defines_8h_a100}


\index{defines.h@{defines.h}!signal_width@{signal\_\-width}}
\index{signal_width@{signal\_\-width}!defines.h@{defines.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}typedef struct {\bf signal\_\-width\_\-s} signal\_\-width}\label{defines_8h_a106}


\index{defines.h@{defines.h}!statistic@{statistic}}
\index{statistic@{statistic}!defines.h@{defines.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}typedef struct {\bf statistic\_\-s} statistic}\label{defines_8h_a108}


\index{defines.h@{defines.h}!str_link@{str\_\-link}}
\index{str_link@{str\_\-link}!defines.h@{defines.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}typedef struct {\bf str\_\-link\_\-s} str\_\-link}\label{defines_8h_a97}


\index{defines.h@{defines.h}!symtable@{symtable}}
\index{symtable@{symtable}!defines.h@{defines.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}typedef struct {\bf symtable\_\-s} symtable}\label{defines_8h_a105}


\index{defines.h@{defines.h}!vector@{vector}}
\index{vector@{vector}!defines.h@{defines.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}typedef struct {\bf vector\_\-s} vector}\label{defines_8h_a98}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}enum bool}\label{defines_8h_a112}
