...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void signal\_\-add\_\-expression ({\bf signal} $\ast$ {\em sig}, {\bf expression} $\ast$ {\em expr})}\label{signal_8c_a6}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf signal}$\ast$ signal\_\-create (char $\ast$ {\em name}, int {\em width}, int {\em lsb}, int {\em is\_\-static})}\label{signal_8c_a1}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} signal\_\-db\_\-read (char $\ast$$\ast$ {\em line}, {\bf module} $\ast$ {\em curr\_\-mod})}\label{signal_8c_a4}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void signal\_\-dealloc ({\bf signal} $\ast$ {\em sig})}\label{signal_8c_a8}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} signal\_\-set\_\-value ({\bf signal} $\ast$ {\em sig}, {\bf nibble} $\ast$ {\em value}, int {\em num\_\-bits}, int {\em from\_\-lsb}, int {\em to\_\-lsb})}\label{signal_8c_a5}
