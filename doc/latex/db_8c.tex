...
{\bf expression} $\ast$ {\bf db\_\-create\_\-expression} ({\bf expression} $\ast$right, {\bf expression} $\ast$left, int op, char $\ast$sig\_\-name)
...
{\bf statement} $\ast$ {\bf db\_\-create\_\-statement} (int line\_\-begin, int line\_\-end, {\bf expression} $\ast$exp)
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf expression}$\ast$ db\_\-create\_\-expression ({\bf expression} $\ast$ {\em right}, {\bf expression} $\ast$ {\em left}, int {\em op}, char $\ast$ {\em sig\_\-name})}\label{db_8c_a20}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf statement}$\ast$ db\_\-create\_\-statement (int {\em line\_\-begin}, int {\em line\_\-end}, {\bf expression} $\ast$ {\em exp})}\label{db_8c_a22}
...
\begin{description}
\item[{\em 
line\_\-begin}]Line number where statement starts. \item[{\em 
line\_\-end}]Line number where statement ends. \item[{\em 
