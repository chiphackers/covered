...
{\bf expression} $\ast$ {\bf db\_\-create\_\-statement} (int line, {\bf expression} $\ast$exp)
...
void {\bf db\_\-connect\_\-statement\_\-true} ({\bf expression} $\ast$stmt, {\bf expression} $\ast$exp\_\-true)
\begin{CompactList}\small\item\em Connects true statement to specified statement.\item\end{CompactList}\item 
void {\bf db\_\-connect\_\-statement\_\-false} ({\bf expression} $\ast$stmt, {\bf expression} $\ast$exp\_\-false)
...
void {\bf db\_\-handle\_\-statement} ({\bf expression} $\ast$exp)
\item 
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-assign\_\-symbol (char $\ast$ {\em name}, char $\ast$ {\em symbol})}\label{db_8c_a27}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-connect\_\-statement\_\-false ({\bf expression} $\ast$ {\em stmt}, {\bf expression} $\ast$ {\em exp\_\-false})}\label{db_8c_a24}
...
\begin{description}
\item[{\em 
stmt}]Pointer to statement to add to module expression list. \item[{\em 
exp\_\-false}]Pointer to statement to run if statement evaluates to TRUE.\end{description}
\end{Desc}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-connect\_\-statement\_\-true ({\bf expression} $\ast$ {\em stmt}, {\bf expression} $\ast$ {\em exp\_\-true})}\label{db_8c_a23}
...
\item[{\em 
stmt}]Pointer to statement to add to module expression list. \item[{\em 
exp\_\-true}]Pointer to statement to run if statement evaluates to TRUE.\end{description}
\end{Desc}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf expression}$\ast$ db\_\-create\_\-statement (int {\em line}, {\bf expression} $\ast$ {\em exp})}\label{db_8c_a22}
...
\begin{description}
\item[{\em 
line}]Line number where statement is parsed from. \item[{\em 
exp}]Pointer to associated \char`\"{}root\char`\"{} expression.\end{description}
\end{Desc}
\begin{Desc}
\item[Returns: ]\par
Returns pointer to expression containing statement.\end{Desc}
Creates an expression with the STMT operation set. Because statements are setup a bit differently than regular expressions (parent points to associated expression while right and left may point to other expressions), the parameter list is modified from the db\_\-create\_\-expression function. Adds created statement expression to current module's expression list. \index{db.c@{db.c}!db_do_timestep@{db\_\-do\_\-timestep}}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-find\_\-set\_\-add\_\-signal (char $\ast$ {\em symbol}, {\bf vector} $\ast$ {\em vec})}\label{db_8c_a29}
...
Searches symbol table for specified symbol. If the corresponding signal is valid, returns the width value of the signal to the calling function. \index{db.c@{db.c}!db_handle_statement@{db\_\-handle\_\-statement}}
\index{db_handle_statement@{db\_\-handle\_\-statement}!db.c@{db.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-handle\_\-statement ({\bf expression} $\ast$ {\em exp})}\label{db_8c_a30}
...
\begin{description}
\item[{\em 
exp}]Pointer to current expression to evaluate and traverse.\end{description}
\end{Desc}
Recursively searches through specified tree, following the path to changed expressions as specified by the LEFT\_\-CHANGED and RIGHT\_\-CHANGED bits. When an expression is found that does not have its LEFT\_\-CHANGED and RIGHT\_\-CHANGED bits set, we have found a leaf expression, so place this expression at the end of the expression queue. If the specified expression is a statement and no CHANGED bits are set, evaluate the value and add the next statement to the tail of the expression queue. This function is called by the db\_\-do\_\-timestep function. \index{db.c@{db.c}!db_read@{db\_\-read}}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-set\_\-vcd\_\-scope (char $\ast$ {\em scope})}\label{db_8c_a25}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} db\_\-symbol\_\-found (char $\ast$ {\em symbol})}\label{db_8c_a28}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void db\_\-vcd\_\-upscope ()}\label{db_8c_a26}
