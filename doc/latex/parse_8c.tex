...
int {\bf VLparse} ()
\item 
int {\bf parse\_\-readline} (FILE $\ast$file, char $\ast$line, int size)
\item 
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} parse\_\-and\_\-score\_\-dumpfile (char $\ast$ {\em top}, char $\ast$ {\em db}, char $\ast$ {\em vcd})}\label{parse_8c_a8}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} parse\_\-design (char $\ast$ {\em top}, char $\ast$ {\em output\_\-db})}\label{parse_8c_a7}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int parse\_\-readline (FILE $\ast$ {\em file}, char $\ast$ {\em line}, int {\em size})}\label{parse_8c_a6}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void reset\_\-lexer (FILE $\ast$ {\em out}, {\bf str\_\-link} $\ast$ {\em file\_\-list\_\-head})}\label{parse_8c_a4}


\index{parse.c@{parse.c}!VLparse@{VLparse}}
\index{VLparse@{VLparse}!parse.c@{parse.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int VLparse ()}\label{parse_8c_a5}
...
Pointer to head element of used files list \index{parse.c@{parse.c}!VLdebug@{VLdebug}}
