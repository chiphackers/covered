...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define ECHO\ (void) fwrite( {\bf yytext}, {\bf yyleng}, 1, {\bf yyout} )}\label{lexer_8c_a69}
...
{\bf keyword} {\rm (p.\,\pageref{structkeyword})}}]If set to 1, specifies that a {\bf keyword} {\rm (p.\,\pageref{structkeyword})} is in the value\end{description}
\end{Desc}
