...
\end{Desc}
Outputs the verbose coverage report for the specified module instance to the specified output stream. \index{comb.c@{comb.c}!combination_module_summary@{combination\_\-module\_\-summary}}
