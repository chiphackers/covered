...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf statement}$\ast$ statement\_\-create ({\bf expression} $\ast$ {\em exp}, int {\em line})}\label{statement_8h_a0}


Creates new statement structure.

\index{statement.h@{statement.h}!statement_db_read@{statement\_\-db\_\-read}}
