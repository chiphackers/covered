...
#define EXPRESSION_IS_STATIC_ONLY 677
...
#define VECTOR_FROM_STRING 800
#define VECTOR_VCD_ASSIGN 801
#define VECTOR_BITWISE_AND_OP 802
#define VECTOR_BITWISE_NAND_OP 803
#define VECTOR_BITWISE_OR_OP 804
#define VECTOR_BITWISE_NOR_OP 805
#define VECTOR_BITWISE_XOR_OP 806
#define VECTOR_BITWISE_NXOR_OP 807
#define VECTOR_OP_LT 808
#define VECTOR_OP_LE 809
#define VECTOR_OP_GT 810
#define VECTOR_OP_GE 811
#define VECTOR_OP_EQ 812
#define VECTOR_CEQ_ULONG 813
#define VECTOR_OP_CEQ 814
#define VECTOR_OP_CXEQ 815
#define VECTOR_OP_CZEQ 816
#define VECTOR_OP_NE 817
#define VECTOR_OP_CNE 818
#define VECTOR_OP_LOR 819
#define VECTOR_OP_LAND 820
...
#define VECTOR_OP_DIVIDE 828
#define VECTOR_OP_MODULUS 829
#define VECTOR_OP_INC 830
#define VECTOR_OP_DEC 831
#define VECTOR_UNARY_INV 832
#define VECTOR_UNARY_AND 833
#define VECTOR_UNARY_NAND 834
#define VECTOR_UNARY_OR 835
#define VECTOR_UNARY_NOR 836
#define VECTOR_UNARY_XOR 837
#define VECTOR_UNARY_NXOR 838
#define VECTOR_UNARY_NOT 839
#define VECTOR_OP_EXPAND 840
#define VECTOR_OP_LIST 841
#define VECTOR_DEALLOC_VALUE 842
#define VECTOR_DEALLOC 843
#define SYMTABLE_ADD_SYM_SIG 844
#define SYMTABLE_INIT 845
#define SYMTABLE_CREATE 846
#define SYMTABLE_ADD 847
#define SYMTABLE_SET_VALUE 848
#define SYMTABLE_ASSIGN 849
#define SYMTABLE_DEALLOC 850
#define FUNIT_INIT 851
#define FUNIT_CREATE 852
#define FUNIT_GET_CURR_MODULE 853
#define FUNIT_GET_CURR_MODULE_SAFE 854
#define FUNIT_GET_CURR_FUNCTION 855
#define FUNIT_GET_CURR_TASK 856
#define FUNIT_GET_PORT_COUNT 857
#define FUNIT_FIND_PARAM 858
#define FUNIT_FIND_SIGNAL 859
#define FUNIT_REMOVE_STMT_BLKS_CALLING_STMT 860
#define FUNIT_GEN_TASK_FUNCTION_NAMEDBLOCK_NAME 861
#define FUNIT_SIZE_ELEMENTS 862
#define FUNIT_DB_WRITE 863
#define FUNIT_DB_READ 864
#define FUNIT_VERSION_DB_READ 865
#define FUNIT_DB_MERGE 866
#define FUNIT_MERGE 867
#define FUNIT_FLATTEN_NAME 868
#define FUNIT_FIND_BY_ID 869
#define FUNIT_IS_TOP_MODULE 870
#define FUNIT_IS_UNNAMED 871
#define FUNIT_IS_UNNAMED_CHILD_OF 872
#define FUNIT_IS_CHILD_OF 873
#define FUNIT_DISPLAY_SIGNALS 874
#define FUNIT_DISPLAY_EXPRESSIONS 875
#define STATEMENT_ADD_THREAD 876
#define FUNIT_PUSH_THREADS 877
#define STATEMENT_DELETE_THREAD 878
#define FUNIT_OUTPUT_DUMPVARS 879
#define FUNIT_CLEAN 880
#define FUNIT_DEALLOC 881
#define ARC_FIND_FROM_STATE 882
#define ARC_FIND_TO_STATE 883
#define ARC_FIND_ARC 884
#define ARC_FIND_ARC_BY_EXCLUSION_ID 885
#define ARC_CREATE 886
#define ARC_ADD 887
#define ARC_STATE_HITS 888
#define ARC_TRANSITION_HITS 889
#define ARC_TRANSITION_EXCLUDED 890
#define ARC_GET_STATS 891
#define ARC_DB_WRITE 892
#define ARC_DB_READ 893
#define ARC_DB_MERGE 894
#define ARC_MERGE 895
#define ARC_GET_STATES 896
#define ARC_GET_TRANSITIONS 897
#define ARC_ARE_ANY_EXCLUDED 898
#define ARC_DEALLOC 899
#define LEXER_KEYWORD_SYS_1995_CODE 900
#define FUNC_ITER_DISPLAY 901
#define FUNC_ITER_SORT 902
#define FUNC_ITER_COUNT_STMT_ITERS 903
#define FUNC_ITER_ADD_STMT_ITERS 904
#define FUNC_ITER_ADD_SIG_LINKS 905
#define FUNC_ITER_INIT 906
#define FUNC_ITER_GET_NEXT_STATEMENT 907
#define FUNC_ITER_GET_NEXT_SIGNAL 908
#define FUNC_ITER_DEALLOC 909
#define EXCLUDE_EXPR_ASSIGN_AND_RECALC 910
#define EXCLUDE_SIG_ASSIGN_AND_RECALC 911
#define EXCLUDE_ARC_ASSIGN_AND_RECALC 912
#define EXCLUDE_ADD_EXCLUDE_REASON 913
#define EXCLUDE_REMOVE_EXCLUDE_REASON 914
#define EXCLUDE_IS_LINE_EXCLUDED 915
#define EXCLUDE_SET_LINE_EXCLUDE 916
#define EXCLUDE_IS_TOGGLE_EXCLUDED 917
#define EXCLUDE_SET_TOGGLE_EXCLUDE 918
#define EXCLUDE_IS_COMB_EXCLUDED 919
#define EXCLUDE_SET_COMB_EXCLUDE 920
#define EXCLUDE_IS_FSM_EXCLUDED 921
#define EXCLUDE_SET_FSM_EXCLUDE 922
#define EXCLUDE_IS_ASSERT_EXCLUDED 923
#define EXCLUDE_SET_ASSERT_EXCLUDE 924
#define EXCLUDE_FIND_EXCLUDE_REASON 925
#define EXCLUDE_DB_WRITE 926
#define EXCLUDE_DB_READ 927
#define EXCLUDE_RESOLVE_REASON 928
#define EXCLUDE_DB_MERGE 929
#define EXCLUDE_FIND_SIGNAL 930
#define EXCLUDE_FIND_EXPRESSION 931
#define EXCLUDE_FIND_FSM_ARC 932
#define EXCLUDE_FORMAT_REASON 933
#define EXCLUDED_GET_MESSAGE 934
#define EXCLUDE_HANDLE_EXCLUDE_REASON 935
#define EXCLUDE_PRINT_EXCLUSION 936
#define EXCLUDE_LINE_FROM_ID 937
#define EXCLUDE_TOGGLE_FROM_ID 938
#define EXCLUDE_MEMORY_FROM_ID 939
#define EXCLUDE_EXPR_FROM_ID 940
#define EXCLUDE_FSM_FROM_ID 941
#define EXCLUDE_ASSERT_FROM_ID 942
#define EXCLUDE_APPLY_EXCLUSIONS 943
#define COMMAND_EXCLUDE 944
#define RACE_BLK_CREATE 945
#define RACE_FIND_HEAD_STATEMENT_CONTAINING_STATEMENT_HELPER 946
#define RACE_FIND_HEAD_STATEMENT_CONTAINING_STATEMENT 947
#define RACE_GET_HEAD_STATEMENT 948
#define RACE_FIND_HEAD_STATEMENT 949
#define RACE_CALC_STMT_BLK_TYPE 950
#define RACE_CALC_EXPR_ASSIGNMENT 951
#define RACE_CALC_ASSIGNMENTS 952
#define RACE_HANDLE_RACE_CONDITION 953
#define RACE_CHECK_ASSIGNMENT_TYPES 954
#define RACE_CHECK_ONE_BLOCK_ASSIGNMENT 955
#define RACE_CHECK_RACE_COUNT 956
#define RACE_CHECK_MODULES 957
#define RACE_DB_WRITE 958
#define RACE_DB_READ 959
#define RACE_GET_STATS 960
#define RACE_REPORT_SUMMARY 961
#define RACE_REPORT_VERBOSE 962
#define RACE_REPORT 963
#define RACE_COLLECT_LINES 964
#define RACE_BLK_DELETE_LIST 965
#define STATISTIC_CREATE 966
#define STATISTIC_IS_EMPTY 967
#define STATISTIC_DEALLOC 968
#define TCL_FUNC_GET_RACE_REASON_MSGS 969
#define TCL_FUNC_GET_FUNIT_LIST 970
#define TCL_FUNC_GET_INSTANCES 971
#define TCL_FUNC_GET_INSTANCE_LIST 972
#define TCL_FUNC_IS_FUNIT 973
#define TCL_FUNC_GET_FUNIT 974
#define TCL_FUNC_GET_INST 975
#define TCL_FUNC_GET_FUNIT_NAME 976
#define TCL_FUNC_GET_FILENAME 977
#define TCL_FUNC_INST_SCOPE 978
#define TCL_FUNC_GET_FUNIT_START_AND_END 979
#define TCL_FUNC_COLLECT_UNCOVERED_LINES 980
#define TCL_FUNC_COLLECT_COVERED_LINES 981
#define TCL_FUNC_COLLECT_RACE_LINES 982
#define TCL_FUNC_COLLECT_UNCOVERED_TOGGLES 983
#define TCL_FUNC_COLLECT_COVERED_TOGGLES 984
#define TCL_FUNC_COLLECT_UNCOVERED_MEMORIES 985
#define TCL_FUNC_COLLECT_COVERED_MEMORIES 986
#define TCL_FUNC_GET_TOGGLE_COVERAGE 987
#define TCL_FUNC_GET_MEMORY_COVERAGE 988
#define TCL_FUNC_COLLECT_UNCOVERED_COMBS 989
#define TCL_FUNC_COLLECT_COVERED_COMBS 990
#define TCL_FUNC_GET_COMB_EXPRESSION 991
#define TCL_FUNC_GET_COMB_COVERAGE 992
#define TCL_FUNC_COLLECT_UNCOVERED_FSMS 993
#define TCL_FUNC_COLLECT_COVERED_FSMS 994
#define TCL_FUNC_GET_FSM_COVERAGE 995
#define TCL_FUNC_COLLECT_UNCOVERED_ASSERTIONS 996
#define TCL_FUNC_COLLECT_COVERED_ASSERTIONS 997
#define TCL_FUNC_GET_ASSERT_COVERAGE 998
#define TCL_FUNC_OPEN_CDD 999
#define TCL_FUNC_CLOSE_CDD 1000
#define TCL_FUNC_SAVE_CDD 1001
#define TCL_FUNC_MERGE_CDD 1002
#define TCL_FUNC_GET_LINE_SUMMARY 1003
#define TCL_FUNC_GET_TOGGLE_SUMMARY 1004
#define TCL_FUNC_GET_MEMORY_SUMMARY 1005
#define TCL_FUNC_GET_COMB_SUMMARY 1006
#define TCL_FUNC_GET_FSM_SUMMARY 1007
#define TCL_FUNC_GET_ASSERT_SUMMARY 1008
#define TCL_FUNC_PREPROCESS_VERILOG 1009
#define TCL_FUNC_GET_SCORE_PATH 1010
#define TCL_FUNC_GET_INCLUDE_PATHNAME 1011
#define TCL_FUNC_GET_GENERATION 1012
#define TCL_FUNC_SET_LINE_EXCLUDE 1013
#define TCL_FUNC_SET_TOGGLE_EXCLUDE 1014
#define TCL_FUNC_SET_MEMORY_EXCLUDE 1015
#define TCL_FUNC_SET_COMB_EXCLUDE 1016
#define TCL_FUNC_FSM_EXCLUDE 1017
#define TCL_FUNC_SET_ASSERT_EXCLUDE 1018
#define TCL_FUNC_GENERATE_REPORT 1019
#define TCL_FUNC_INITIALIZE 1020
#define STATIC_EXPR_GEN_UNARY 1021
#define STATIC_EXPR_GEN 1022
#define STATIC_EXPR_CALC_LSB_AND_WIDTH_PRE 1023
#define STATIC_EXPR_CALC_LSB_AND_WIDTH_POST 1024
#define STATIC_EXPR_DEALLOC 1025
#define VCDID 1026
#define VCD_CALLBACK 1027
#define LXT_PARSE 1028
#define COMMAND_MERGE 1029
#define LINE_GET_STATS 1030
#define LINE_COLLECT 1031
#define LINE_GET_FUNIT_SUMMARY 1032
#define LINE_GET_INST_SUMMARY 1033
#define LINE_DISPLAY_INSTANCE_SUMMARY 1034
#define LINE_INSTANCE_SUMMARY 1035
#define LINE_DISPLAY_FUNIT_SUMMARY 1036
#define LINE_FUNIT_SUMMARY 1037
#define LINE_DISPLAY_VERBOSE 1038
#define LINE_INSTANCE_VERBOSE 1039
#define LINE_FUNIT_VERBOSE 1040
#define LINE_REPORT 1041
