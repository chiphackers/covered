...
static_expr_port_list
  : static_expr_port_list ',' static_expr
    {
      if( parse_mode ) {
        $$ = parser_append_se_port_list( $1, $3, @1.first_line, @1.ppline, @1.first_column, @3.first_line, @3.ppline, @3.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | static_expr
    {
      if( parse_mode ) {
        $$ = parser_create_se_port_list( $1, @1.first_line, @1.ppline, @1.first_column, @1.last_column );
      } else {
        $$ = NULL;
      }
    }
...
static_expr
  ...
  | static_unary_op static_expr_primary %prec UNARY_PREC
    {
      if( parse_mode ) {
        $$ = parser_create_unary_se( $2, $1, @1.first_line, @1.ppline, @1.first_column, @1.last_column );
      } else {
        $$ = NULL;
      }
    }
  | static_expr '^' static_expr
    {
      if( parse_mode ) {
        $$ = static_expr_gen( $3, $1, EXP_OP_XOR, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL );
      } else {
        $$ = NULL;
      }
    }
  | static_expr '*' static_expr
    {
      if( parse_mode ) {
        $$ = static_expr_gen( $3, $1, EXP_OP_MULTIPLY, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL );
      } else {
        $$ = NULL;
      }
    }
  | static_expr '/' static_expr
    {
      if( parse_mode ) {
        $$ = static_expr_gen( $3, $1, EXP_OP_DIVIDE, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL );
      } else {
        $$ = NULL;
      }
    }
  | static_expr '%' static_expr
    {
      if( parse_mode ) {
        $$ = static_expr_gen( $3, $1, EXP_OP_MOD, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL );
      } else {
        $$ = NULL;
      }
    }
  | static_expr '+' static_expr
    {
      if( parse_mode ) {
        $$ = static_expr_gen( $3, $1, EXP_OP_ADD, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL );
      } else {
        $$ = NULL;
      }
    }
  | static_expr '-' static_expr
    {
      if( parse_mode ) {
        $$ = static_expr_gen( $3, $1, EXP_OP_SUBTRACT, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL );
      } else {
        $$ = NULL;
      }
    }
  | static_expr '&' static_expr
    {
      if( parse_mode ) {
        $$ = static_expr_gen( $3, $1, EXP_OP_AND, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL );
      } else {
        $$ = NULL;
      }
    }
  | static_expr '|' static_expr
    {
      if( parse_mode ) {
        $$ = static_expr_gen( $3, $1, EXP_OP_OR, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL );
      } else {
        $$ = NULL;
      }
    }
  | static_expr K_NOR static_expr
    {
      if( parse_mode ) {
        $$ = static_expr_gen( $3, $1, EXP_OP_NOR, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL );
      } else {
        $$ = NULL;
      }
    }
  | static_expr K_NAND static_expr
    {
      if( parse_mode ) {
        $$ = static_expr_gen( $3, $1, EXP_OP_NAND, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL );
      } else {
        $$ = NULL;
      }
    }
  | static_expr K_NXOR static_expr
    {
      if( parse_mode ) {
        $$ = static_expr_gen( $3, $1, EXP_OP_NXOR, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL );
      } else {
        $$ = NULL;
      }
    }
  | static_expr K_LS static_expr
    {
      if( parse_mode ) {
        $$ = static_expr_gen( $3, $1, EXP_OP_LSHIFT, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL );
      } else {
        $$ = NULL;
      }
    }
  | static_expr K_RS static_expr
    {
      if( parse_mode ) {
        $$ = static_expr_gen( $3, $1, EXP_OP_RSHIFT, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL );
      } else {
        $$ = NULL;
      }
    }
  | static_expr K_GE static_expr
    {
      if( parse_mode ) {
        $$ = static_expr_gen( $3, $1, EXP_OP_GE, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL );
      } else {
        $$ = NULL;
      }
    }
  | static_expr K_LE static_expr
    {
      if( parse_mode ) {
        $$ = static_expr_gen( $3, $1, EXP_OP_LE, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL );
      } else {
        $$ = NULL;
      }
    }
  | static_expr K_EQ static_expr
    {
      if( parse_mode ) {
        $$ = static_expr_gen( $3, $1, EXP_OP_EQ, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL );
      } else {
        $$ = NULL;
      }
    }
  ...
  | static_expr '>' static_expr
    {
      if( parse_mode ) {
        $$ = static_expr_gen( $3, $1, EXP_OP_GT, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL );
      } else {
        $$ = NULL;
      }
    }
...
static_expr_primary
      ...
      if( parse_mode ) {
        ...
        if( (ignore_mode == 0) && ($1.vec != NULL) ) {
          ...
          if( vector_is_unknown( $1.vec ) ) {
            Try {
              tmp->exp = db_create_expression( NULL, NULL, EXP_OP_STATIC, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@1.last_column - 1), NULL, TRUE );
    ...
    { PROFILE(PARSER_STATIC_EXPR_PRIMARY_B);
      if( parse_mode ) {
        ...
        if( ignore_mode == 0 ) {
          ...
          tmp->num = -1;
          Try {
            tmp->exp = db_create_expression( NULL, NULL, EXP_OP_SIG, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@1.last_column - 1), $1, TRUE );
          } Catch_anonymous {
            error_count++;
          }
          $$ = tmp;
  ...
  | IDENTIFIER '(' static_expr_port_list ')'
    {
      if( parse_mode ) {
        if( ignore_mode == 0 ) {
          $$ = static_expr_gen( NULL, $3, EXP_OP_FUNC_CALL, @1.first_line, @1.ppline, @1.first_column, (@4.last_column - 1), $1 );
        } else {
          static_expr_dealloc( $3, TRUE );
          $$ = NULL;
        }
  ...
  | IDENTIFIER '[' static_expr ']'
    {
      if( parse_mode ) {
        if( ignore_mode == 0 ) { 
          $$ = static_expr_gen( NULL, $3, EXP_OP_SBIT_SEL, @1.first_line, @1.ppline, @1.first_column, (@4.last_column - 1), $1 );
        } else {
          static_expr_dealloc( $3, TRUE );
          $$ = NULL;
        }
  ...
  | S_random
    {
      if( parse_mode ) {
        $$ = parser_create_syscall_se( EXP_OP_SRANDOM, @1.first_line, @1.ppline, @1.first_column, @1.last_column );
      } else {
        $$ = NULL;
      }
    }
  | S_urandom
    {
      if( parse_mode ) {
        $$ = parser_create_syscall_se( EXP_OP_SURANDOM, @1.first_line, @1.ppline, @1.first_column, @1.last_column );
      } else {
        $$ = NULL;
      }
    }
...
expression
  ...
  | expression '^' expression
    {
      if( parse_mode ) {
        $$ = parser_create_binary_exp( $1, $3, EXP_OP_XOR, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | expression '*' expression
    {
      if( parse_mode ) {
        $$ = parser_create_binary_exp( $1, $3, EXP_OP_MULTIPLY, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | expression '/' expression
    {
      if( parse_mode ) {
        $$ = parser_create_binary_exp( $1, $3, EXP_OP_DIVIDE, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | expression '%' expression
    {
      if( parse_mode ) {
        $$ = parser_create_binary_exp( $1, $3, EXP_OP_MOD, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | expression '+' expression
    {
      if( parse_mode ) {
        $$ = parser_create_binary_exp( $1, $3, EXP_OP_ADD, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | expression '-' expression
    {
      if( parse_mode ) {
        $$ = parser_create_binary_exp( $1, $3, EXP_OP_SUBTRACT, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | expression '&' expression
    {
      if( parse_mode ) {
        $$ = parser_create_binary_exp( $1, $3, EXP_OP_AND, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | expression '|' expression
    {
      if( parse_mode ) {
        $$ = parser_create_binary_exp( $1, $3, EXP_OP_OR, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | expression K_NAND expression
    {
      if( parse_mode ) {
        $$ = parser_create_binary_exp( $1, $3, EXP_OP_NAND, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | expression K_NOR expression
    {
      if( parse_mode ) {
        $$ = parser_create_binary_exp( $1, $3, EXP_OP_NOR, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | expression K_NXOR expression
    {
      if( parse_mode ) {
        $$ = parser_create_binary_exp( $1, $3, EXP_OP_NXOR, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | expression '<' expression
    {
      if( parse_mode ) {
        $$ = parser_create_binary_exp( $1, $3, EXP_OP_LT, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | expression '>' expression
    {
      if( parse_mode ) {
        $$ = parser_create_binary_exp( $1, $3, EXP_OP_GT, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | expression K_LS expression
    {
      if( parse_mode ) {
        $$ = parser_create_binary_exp( $1, $3, EXP_OP_LSHIFT, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | expression K_RS expression
    {
      if( parse_mode ) {
        $$ = parser_create_binary_exp( $1, $3, EXP_OP_RSHIFT, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | expression K_EQ expression
    {
      if( parse_mode ) {
        $$ = parser_create_binary_exp( $1, $3, EXP_OP_EQ, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | expression K_CEQ expression
    {
      if( parse_mode ) {
        $$ = parser_create_binary_exp( $1, $3, EXP_OP_CEQ, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | expression K_LE expression
    {
      if( parse_mode ) {
        $$ = parser_create_binary_exp( $1, $3, EXP_OP_LE, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | expression K_GE expression
    {
      if( parse_mode ) {
        $$ = parser_create_binary_exp( $1, $3, EXP_OP_GE, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | expression K_NE expression
    {
      if( parse_mode ) {
        $$ = parser_create_binary_exp( $1, $3, EXP_OP_NE, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | expression K_CNE expression
    {
      if( parse_mode ) {
        $$ = parser_create_binary_exp( $1, $3, EXP_OP_CNE, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | expression K_LOR expression
    {
      if( parse_mode ) {
        $$ = parser_create_binary_exp( $1, $3, EXP_OP_LOR, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | expression K_LAND expression
    {
      if( parse_mode ) {
        $$ = parser_create_binary_exp( $1, $3, EXP_OP_LAND, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | expression K_POW expression
    {
      if( parse_mode ) {
        if( !parser_check_generation( GENERATION_2001 ) ) {
          ...
          $$ = parser_create_binary_exp( $1, $3, EXP_OP_EXPONENT, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
        }
      } else {
        $$ = NULL;
      }
  ...
  | expression K_LSS expression
    {
      if( parse_mode ) {
        if( !parser_check_generation( GENERATION_2001 ) ) {
          ...
          $$ = parser_create_binary_exp( $1, $3, EXP_OP_ALSHIFT, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
        }
      } else {
        $$ = NULL;
      }
  ...
  | expression K_RSS expression
    {
      if( parse_mode ) {
        if( !parser_check_generation( GENERATION_2001 ) ) {
          ...
          $$ = parser_create_binary_exp( $1, $3, EXP_OP_ARSHIFT, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
        }
      } else {
        $$ = NULL;
      }
  ...
  | expression '?' expression ':' expression
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) && ($3 != NULL) && ($5 != NULL) ) {
          Try {
            expression* csel = db_create_expression( $5, $3, EXP_OP_COND_SEL, lhs_mode, $3->line, $3->ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
            $$ = db_create_expression( csel, $1, EXP_OP_COND, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@5.last_column - 1), NULL, in_static_expr );
          } Catch_anonymous {
            error_count++;
            $$ = NULL;
          }
...
expr_primary
  : number
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1.vec != NULL) ) {
          Try {
            $$ = db_create_expression( NULL, NULL, EXP_OP_STATIC, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@1.last_column - 1), NULL, in_static_expr );
  ...
  | identifier
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) ) {
          Try {
            $$ = db_create_expression( NULL, NULL, EXP_OP_SIG, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@1.last_column - 1), $1, in_static_expr );
          } Catch_anonymous {
            error_count++;
            $$ = NULL;
          }
  ...
  | identifier post_op_and_assign_op
    {
      if( parse_mode ) {
        $$ = parser_create_op_and_assign_exp( $1, $2, @1.first_line, @1.ppline, @1.first_column, @1.last_column, @2.last_column );
      } else {
        $$ = NULL;
      }
    }
  | pre_op_and_assign_op identifier
    {
      if( parse_mode ) {
        $$ = parser_create_op_and_assign_exp( $2, $1, @1.first_line, @1.ppline, @1.first_column, @1.last_column, @2.last_column );
      } else {
        $$ = NULL;
      }
    }
  ...
  | syscall_wo_parms_op
    {
      if( parse_mode ) {
        $$ = parser_create_syscall_exp( $1, @1.first_line, @1.ppline, @1.first_column, @1.last_column );
      } else {
        $$ = NULL;
      }
    }
  ...
  | identifier index_expr post_op_and_assign_op
    {
      if( parse_mode ) {
        $$ = parser_create_op_and_assign_w_dim_exp( $1, $3, $2, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | pre_op_and_assign_op identifier index_expr
    {
      if( parse_mode ) {
        $$ = parser_create_op_and_assign_w_dim_exp( $2, $1, $3, @1.first_line, @1.ppline, @1.first_column, @3.last_column );
      } else {
        $$ = NULL;
      }
    }
  | identifier '(' expression_port_list ')'
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) && ($3 != NULL ) ) {
          Try {
            $$ = db_create_expression( NULL, $3, EXP_OP_FUNC_CALL, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@4.last_column - 1), $1, in_static_expr );
          } Catch_anonymous {
            error_count++;
            $$ = NULL;
          }
  ...
  | syscall_w_parms_op '(' expression_systask_list ')'
    {
      if( parse_mode ) {
        $$ = parser_create_syscall_w_params_exp( $1, $3, @1.first_line, @1.ppline, @1.first_column, @4.last_column );
      } else {
        $$ = NULL;
      }
    }
  | syscall_w_parms_op_64 '(' expression_systask_list ')'
    {
      if( parse_mode ) {
        if( ($$ = parser_create_syscall_w_params_exp( $1, $3, @1.first_line, @1.ppline, @1.first_column, @4.last_column )) != NULL ) {
  ...
  | '{' expression_list '}'
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($2 != NULL) ) {
          Try {
            $$ = db_create_expression( $2, NULL, EXP_OP_CONCAT, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
          } Catch_anonymous {
            error_count++;
            $$ = NULL;
          }
  ...
  | '{' expression '{' expression_list '}' '}'
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($2 != NULL) && ($4 != NULL) ) {
          Try {
            $$ = db_create_expression( $4, $2, EXP_OP_EXPAND, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@6.last_column - 1), NULL, in_static_expr );
          } Catch_anonymous {
            error_count++;
            $$ = NULL;
          }
      ...
      if( parse_mode ) {
        if( ignore_mode == 0 ) {
          if( param_mode == 0 ) {
            if( $3 != NULL ) {
              Try {
                $$ = db_create_expression( $3, $1, EXP_OP_LIST, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
              } Catch_anonymous {
                error_count++;
                $$ = NULL;
              }
  ...
  : expression_port_list ',' expression
    {
      if( parse_mode ) {
        if( ignore_mode == 0 ) {
          if( $3 != NULL ) {
            Try {
              expression* tmp = db_create_expression( $3, NULL, EXP_OP_PASSIGN, lhs_mode, @3.first_line, @3.ppline, @3.first_column, (@3.last_column - 1), NULL, in_static_expr );
              $$ = db_create_expression( tmp, $1, EXP_OP_PLIST, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
            } Catch_anonymous {
              error_count++;
              $$ = NULL;
            }
  ...
  | expression
    {
      if( parse_mode ) {
        if( ignore_mode == 0 ) {
          Try {
            $$ = db_create_expression( $1, NULL, EXP_OP_PASSIGN, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@1.last_column - 1), NULL, in_static_expr );
          } Catch_anonymous {
            error_count++;
            $$ = NULL;
          }
  ...
  : expression_systask_list ',' expression
    {
      if( parse_mode ) {
        if( ignore_mode == 0 ) {
          if( $3 != NULL ) {
            Try {
              expression* tmp = db_create_expression( $3, NULL, EXP_OP_SASSIGN, lhs_mode, @3.first_line, @3.ppline, @3.first_column, (@3.last_column - 1), NULL, in_static_expr );
              $$ = db_create_expression( tmp, $1, EXP_OP_PLIST, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
            } Catch_anonymous {
              expression_dealloc( $3, FALSE );
              error_count++;
  ...
  | expression
    {
      if( parse_mode ) {
        if( ignore_mode == 0 ) {
          Try {
            $$ = db_create_expression( $1, NULL, EXP_OP_SASSIGN, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@1.last_column - 1), NULL, in_static_expr );
          } Catch_anonymous {
            expression_dealloc( $1, FALSE );
            error_count++;
            $$ = NULL;
  ...
  : IDENTIFIER '=' static_expr
    {
      if( parse_mode ) {
        ...
        if( ignore_mode == 0 ) {
          if( $3 != NULL ) {
            Try {
              expl = db_create_expression( NULL, NULL, EXP_OP_SIG, TRUE, @1.first_line, @1.ppline, @1.first_column, (@1.last_column - 1), $1, in_static_expr );
              expr = db_create_expr_from_static( $3, @3.first_line, @3.ppline, @3.first_column, (@3.last_column - 1) );
              expr = db_create_expression( expr, expl, EXP_OP_BASSIGN, FALSE, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
        ...
        if( ignore_mode == 0 ) {
          if( $3 != NULL ) {
            Try {
              expr = db_create_expr_from_static( $3, @3.first_line, @3.ppline, @3.first_column, (@3.last_column - 1) );
              expl = db_create_expression( NULL, NULL, EXP_OP_SIG, TRUE, @1.first_line, @1.ppline, @1.first_column, (@1.last_column - 1), $1, in_static_expr );
              expr = db_create_expression( expr, expl, $2, FALSE, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
              if( generate_varname == NULL ) {
                generate_varname = $1;
              } else {
                FREE_TEXT( $1 );
  ...
  | IDENTIFIER post_op_and_assign_op
    {
      if( parse_mode ) {
        ...
        if( ignore_mode == 0 ) {
          Try {
            expr = db_create_expression( NULL, NULL, EXP_OP_SIG, TRUE, @1.first_line, @1.ppline, @1.first_column, (@1.last_column - 1), $1, in_static_expr );
            expr = db_create_expression( NULL, expr, $2, FALSE, @1.first_line, @1.ppline, @1.first_column, (@2.last_column - 1), NULL, in_static_expr );
            if( generate_varname == NULL ) {
              generate_varname = $1;
            } else {
              FREE_TEXT( $1 );
    ...
    generate_item_list_opt end_gen_block K_end
    {
      if( parse_mode ) {
        ...
        if( (ignore_mode == 0) && ($4 != NULL) && ($6 != NULL) && ($8 != NULL) && ($15 != NULL) ) {
          ...
          db_add_expression( db_create_expr_from_static( $6, @6.first_line, @6.ppline, @6.first_column, (@6.last_column - 1)) );
  ...
  | K_if inc_gen_expr_mode '(' static_expr ')' dec_gen_expr_mode gen_if_body
    {
      if( parse_mode ) {
        ...
        if( (ignore_mode == 0) && ($4 != NULL) && ($7.gitem1 != NULL) ) {
          generate_expr_mode++;
          expr = db_create_expr_from_static( $4, @4.first_line, @4.ppline, @4.first_column, (@4.last_column - 1) );
          Try {
            expr = db_create_expression( expr, NULL, EXP_OP_IF, FALSE, @1.first_line, @1.ppline, @1.first_column, (@5.last_column - 1), NULL, in_static_expr );
          } Catch_anonymous {
            error_count++;
          }
        ...
        if( !parser_check_generation( GENERATION_SV ) ) {
          ...
          if( $4 != NULL ) {
            if( (slist = db_create_sensitivity_list( $4 )) == NULL ) {
              ...
              Try {
                slist = db_create_expression( slist, NULL, EXP_OP_ALWAYS_COMB, lhs_mode, @2.first_line, @2.ppline, @2.first_column, (@2.last_column - 1), NULL, in_static_expr );
              } Catch_anonymous {
                error_count++;
              }
        ...
        if( !parser_check_generation( GENERATION_SV ) ) {
          ...
          if( $4 != NULL ) {
            if( (slist = db_create_sensitivity_list( $4 )) == NULL ) {
              ...
              Try {
                slist = db_create_expression( slist, NULL, EXP_OP_ALWAYS_LATCH, lhs_mode, @2.first_line, @2.ppline, @2.first_column, (@2.last_column - 1), NULL, in_static_expr );
              } Catch_anonymous {
                error_count++;
              }
              stmt  = db_create_statement( slist );
  ...
  | attribute_list_opt
    ...
    task_item_list_opt statement_or_null
    {
      if( parse_mode ) {
        ...
        if( ignore_mode == 0 ) {
          if( stmt == NULL ) {
            stmt = db_create_statement( db_create_expression( NULL, NULL, EXP_OP_NOOP, FALSE, @8.first_line, @8.ppline, @8.first_column, (@8.last_column - 1), NULL, in_static_expr ) );
          }
          stmt->suppl.part.head      = 1;
      ...
      if( parse_mode ) {
        ...
        if( (ignore_mode == 0) && ($4 != NULL) ) {
          Try {
            ...
            tmp = db_create_expression( NULL, NULL, EXP_OP_SIG, TRUE, @2.first_line, @2.ppline, @2.first_column, (@2.last_column - 1), $2, in_static_expr );
          } Catch_anonymous {
            error_count++;
          }
          Try {
            tmp = db_create_expression( $4, tmp, EXP_OP_BASSIGN, FALSE, @2.first_line, @2.ppline, @2.first_column, (@4.last_column - 1), NULL, in_static_expr );
      ...
      if( parse_mode ) {
        ...
        if( (ignore_mode == 0) && ($1 != NULL) && ($6 != NULL) ) {
          Try {
            ...
            tmp = db_create_expression( NULL, NULL, EXP_OP_SIG, TRUE, @4.first_line, @4.ppline, @4.first_column, (@4.last_column - 1), $4, in_static_expr );
          } Catch_anonymous {
            error_count++;
          }
          Try {
            tmp = db_create_expression( $6, tmp, EXP_OP_BASSIGN, FALSE, @4.first_line, @4.ppline, @4.first_column, (@6.last_column - 1), NULL, in_static_expr );
            tmp->suppl.part.for_cntrl = 1;
          } Catch_anonymous {
            error_count++;
          }
  ...
  : lpvalue '=' expression
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) && ($3 != NULL) ) {
          Try {
            expression* tmp = db_create_expression( $3, $1, EXP_OP_BASSIGN, FALSE, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
      ...
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) && ($3 != NULL) ) {
          if( !parser_check_generation( GENERATION_SV ) ) {
            ...
            expression* tmp = NULL;
            Try {
              tmp = db_create_expression( $3, $1, EXP_OP_ADD_A, FALSE, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
              tmp->suppl.part.for_cntrl = (for_mode > 0) ? 3 : 0;
            } Catch_anonymous {
              error_count++;
            }
      ...
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) && ($3 != NULL) ) {
          if( !parser_check_generation( GENERATION_SV ) ) {
            ...
            expression* tmp = NULL;
            Try {
              tmp = db_create_expression( $3, $1, EXP_OP_SUB_A, FALSE, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
              tmp->suppl.part.for_cntrl = (for_mode > 0) ? 3 : 0;
            } Catch_anonymous {
              error_count++;
            }
      ...
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) && ($3 != NULL) ) {
          if( !parser_check_generation( GENERATION_SV ) ) {
            ...
            expression* tmp = NULL;
            Try {
              tmp = db_create_expression( $3, $1, EXP_OP_MLT_A, FALSE, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
              tmp->suppl.part.for_cntrl = (for_mode > 0) ? 3 : 0;
            } Catch_anonymous {
              error_count++;
            }
      ...
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) && ($3 != NULL) ) {
          if( !parser_check_generation( GENERATION_SV ) ) {
            ...
            expression* tmp = NULL;
            Try {
              tmp = db_create_expression( $3, $1, EXP_OP_DIV_A, FALSE, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
              tmp->suppl.part.for_cntrl = (for_mode > 0) ? 3 : 0;
            } Catch_anonymous {
              error_count++;
            }
      ...
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) && ($3 != NULL) ) {
          if( !parser_check_generation( GENERATION_SV ) ) {
            ...
            expression* tmp = NULL;
            Try {
              tmp = db_create_expression( $3, $1, EXP_OP_MOD_A, FALSE, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
              tmp->suppl.part.for_cntrl = (for_mode > 0) ? 3 : 0;
            } Catch_anonymous {
              error_count++;
            }
      ...
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) && ($3 != NULL) ) {
          if( !parser_check_generation( GENERATION_SV ) ) {
            ...
            expression* tmp = NULL;
            Try {
              tmp = db_create_expression( $3, $1, EXP_OP_AND_A, FALSE, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
              tmp->suppl.part.for_cntrl = (for_mode > 0) ? 3 : 0;
            } Catch_anonymous {
              error_count++;
            }
      ...
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) && ($3 != NULL) ) {
          if( !parser_check_generation( GENERATION_SV ) ) {
            ...
            expression* tmp = NULL;
            Try {
              tmp = db_create_expression( $3, $1, EXP_OP_OR_A, FALSE, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
              tmp->suppl.part.for_cntrl = (for_mode > 0) ? 3 : 0;
            } Catch_anonymous {
              error_count++;
            }
      ...
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) && ($3 != NULL) ) {
          if( !parser_check_generation( GENERATION_SV ) ) {
            ...
            expression* tmp = NULL;
            Try {
              tmp = db_create_expression( $3, $1, EXP_OP_XOR_A, FALSE, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
              tmp->suppl.part.for_cntrl = (for_mode > 0) ? 3 : 0;
            } Catch_anonymous {
              expression_dealloc( $1, FALSE );
              expression_dealloc( $3, FALSE );
      ...
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) && ($3 != NULL) ) {
          if( !parser_check_generation( GENERATION_SV ) ) {
            ...
            expression* tmp = NULL;
            Try {
              tmp = db_create_expression( $3, $1, EXP_OP_LS_A, FALSE, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
              tmp->suppl.part.for_cntrl = (for_mode > 0) ? 3 : 0;
            } Catch_anonymous {
              expression_dealloc( $1, FALSE );
              expression_dealloc( $3, FALSE );
      ...
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) && ($3 != NULL) ) {
          if( !parser_check_generation( GENERATION_SV ) ) {
            ...
            expression* tmp = NULL;
            Try {
              tmp = db_create_expression( $3, $1, EXP_OP_RS_A, FALSE, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
              tmp->suppl.part.for_cntrl = (for_mode > 0) ? 3 : 0;
            } Catch_anonymous {
              expression_dealloc( $1, FALSE );
              expression_dealloc( $3, FALSE );
      ...
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) && ($3 != NULL) ) {
          if( !parser_check_generation( GENERATION_SV ) ) {
            ...
            expression* tmp = NULL;
            Try {
              tmp = db_create_expression( $3, $1, EXP_OP_ALS_A, FALSE, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
              tmp->suppl.part.for_cntrl = (for_mode > 0) ? 3 : 0;
            } Catch_anonymous {
              expression_dealloc( $1, FALSE );
              expression_dealloc( $3, FALSE );
      ...
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) && ($3 != NULL) ) {
          if( !parser_check_generation( GENERATION_SV ) ) {
            ...
            expression* tmp = NULL;
            Try {
              tmp = db_create_expression( $3, $1, EXP_OP_ARS_A, FALSE, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
              tmp->suppl.part.for_cntrl = (for_mode > 0) ? 3 : 0;
            } Catch_anonymous {
              expression_dealloc( $1, FALSE );
              expression_dealloc( $3, FALSE );
      ...
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) ) {
          if( !parser_check_generation( GENERATION_SV ) ) {
            ...
            expression* tmp = NULL;
            Try {
              tmp = db_create_expression( NULL, $1, EXP_OP_PINC, FALSE, @1.first_line, @1.ppline, @1.first_column, (@2.last_column - 1), NULL, in_static_expr );
              tmp->suppl.part.for_cntrl = (for_mode > 0) ? 3 : 0;
            } Catch_anonymous {
              expression_dealloc( $1, FALSE );
              error_count++;
      ...
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) ) {
          if( !parser_check_generation( GENERATION_SV ) ) {
            ...
            expression* tmp = NULL;
            Try {
              tmp = db_create_expression( NULL, $1, EXP_OP_PDEC, FALSE, @1.first_line, @1.ppline, @1.first_column, (@2.last_column - 1), NULL, in_static_expr );
              tmp->suppl.part.for_cntrl = (for_mode > 0) ? 3 : 0;
            } Catch_anonymous {
              expression_dealloc( $1, FALSE );
              error_count++;
      ...
      if( parse_mode ) {
        ...
        if( ignore_mode == 0 ) {
          ...
          if( $3 != NULL ) {
            ...
            exp  = db_create_expression( NULL, NULL, EXP_OP_NB_CALL, FALSE, @1.first_line, @1.ppline, @1.first_column, (@1.last_column - 1), NULL, in_static_expr );
            exp->elem.funit      = $3;
          ...
          if( ignore_mode == 0 ) {
            ...
            exp  = db_create_expression( NULL, NULL, EXP_OP_NOOP, FALSE, @1.first_line, @1.ppline, @1.first_column, (@1.last_column - 1), NULL, in_static_expr );
            stmt = db_create_statement( exp );
            $$   = stmt;
          }
        }
  ...
  | K_disable identifier ';'
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($2 != NULL) ) {
          expression* exp = NULL;
          Try {
            exp = db_create_expression( NULL, NULL, EXP_OP_DISABLE, FALSE, @1.first_line, @1.ppline, @1.first_column, (@2.last_column - 1), $2, in_static_expr );
          } Catch_anonymous {
            error_count++;
          }
  ...
  | K_TRIGGER IDENTIFIER ';'
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($2 != NULL) ) {
          expression* exp = NULL;
          Try {
            exp = db_create_expression( NULL, NULL, EXP_OP_TRIGGER, FALSE, @1.first_line, @1.ppline, @1.first_column, (@2.last_column - 1), $2, in_static_expr );
          } Catch_anonymous {
            error_count++;
          }
          $$ = db_create_statement( exp );
  ...
  | K_forever inc_block_depth statement dec_block_depth
    {
      if( parse_mode ) {
        if( $3 != NULL ) {
          ...
          statement*  stmt;
          Try {
            expr = db_create_expression( NULL, NULL, EXP_OP_FOREVER, FALSE, @1.first_line, @1.ppline, @1.first_column, (@1.last_column - 1), NULL, in_static_expr );
          } Catch_anonymous {
            error_count++;
          }
    ...
    inc_block_depth statement dec_block_depth
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($3 != NULL) && ($7 != NULL) ) {
          ...
          statement*  stmt;
          Try {
            expr = db_create_expression( NULL, NULL, EXP_OP_STATIC, FALSE, @1.first_line, @1.ppline, @1.first_column, (@1.last_column - 1), NULL, in_static_expr );
          ...
          Try {
            expr = db_create_expression( $3, expr, EXP_OP_REPEAT, FALSE, @1.first_line, @1.ppline, @1.first_column, (@4.last_column - 1), NULL, in_static_expr );
          } Catch_anonymous {
            error_count++;
          }
          stmt = db_create_statement( expr );
    ...
    if_body
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($4 != NULL) ) {
          expression* tmp = NULL;
          Try {
            tmp = db_create_expression( $4, NULL, EXP_OP_IF, FALSE, @2.first_line, @2.ppline, @2.first_column, (@5.last_column - 1), NULL, in_static_expr );
          } Catch_anonymous {
            error_count++;
          }
    ...
    dec_block_depth
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($3 != NULL) && ($7 != NULL) ) {
          expression* expr = NULL;
          Try {
            expr = db_create_expression( $3, NULL, EXP_OP_WHILE, FALSE, @1.first_line, @1.ppline, @1.first_column, (@4.last_column - 1), NULL, in_static_expr );
          } Catch_anonymous {
            error_count++;
          }
  ...
  | K_do inc_block_depth statement dec_block_depth_flush K_while '(' expression ')' ';'
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($3 != NULL) && ($7 != NULL) ) {
          ...
          statement*  stmt;
          Try {
            expr = db_create_expression( $7, NULL, EXP_OP_WHILE, FALSE, @5.first_line, @5.ppline, @5.first_column, (@8.last_column - 1), NULL, in_static_expr );
          } Catch_anonymous {
            error_count++;
          }
        ...
        if( !parser_check_generation( GENERATION_2001 ) ) {
          ...
          if( (ignore_mode == 0) && ($4 != NULL) ) {
            if( (expr = db_create_sensitivity_list( $4 )) == NULL ) {
              ...
              Try {
                expr = db_create_expression( expr, NULL, EXP_OP_SLIST, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@2.last_column - 1), NULL, in_static_expr ); 
              } Catch_anonymous {
                error_count++;
              }
              stmt = db_create_statement( expr );
  ...
  | lpvalue K_LE expression ';'
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) && ($3 != NULL) ) {
          Try {
            expression* tmp = db_create_expression( $3, $1, EXP_OP_NASSIGN, FALSE, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
            $$ = db_create_statement( tmp );
          } Catch_anonymous {
            expression_dealloc( $1, FALSE );
            expression_dealloc( $3, FALSE );
  ...
  | lpvalue '=' delay1 expression ';'
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) && ($3 != NULL) && ($4 != NULL) ) {
          Try {
            expression* tmp = db_create_expression( $4, $3, EXP_OP_DLY_OP, FALSE, @3.first_line, @3.ppline, @3.first_column, (@4.last_column - 1), NULL, in_static_expr );
            tmp = db_create_expression( tmp, $1, EXP_OP_DLY_ASSIGN, FALSE, @1.first_line, @1.ppline, @1.first_column, (@4.last_column - 1), NULL, in_static_expr );
            $$  = db_create_statement( tmp );
          } Catch_anonymous {
            error_count++;
            $$ = NULL;
  ...
  | lpvalue K_LE delay1 expression ';'
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) && ($3 != NULL) && ($4 != NULL) ) {
          Try {
            expression* tmp = db_create_expression( $4, $1, EXP_OP_NASSIGN, FALSE, @1.first_line, @1.ppline, @1.first_column, (@4.last_column - 1), NULL, in_static_expr );
            $$ = db_create_statement( tmp );
          } Catch_anonymous {
            expression_dealloc( $1, FALSE );
            expression_dealloc( $4, FALSE );
  ...
  | lpvalue '=' K_repeat '(' expression ')' event_control expression ';'
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) && ($5 != NULL) && ($7 != NULL) && ($8 != NULL) ) {
          vector* vec = vector_create( 32, VTYPE_VAL, VDATA_UL, TRUE );
          Try {
            expression* tmp = db_create_expression( NULL, NULL, EXP_OP_STATIC, FALSE, @1.first_line, @1.ppline, @1.first_column, (@1.last_column - 1), NULL, in_static_expr );
            (void)vector_from_int( vec, 0x0 );
            assert( tmp->value->value.ul == NULL );
            free_safe( tmp->value, sizeof( vector ) );
            tmp->value = vec;
            tmp = db_create_expression( $5, tmp, EXP_OP_REPEAT, FALSE, @3.first_line, @3.ppline, @3.first_column, (@6.last_column - 1), NULL, in_static_expr );
            tmp = db_create_expression( $7, tmp, EXP_OP_RPT_DLY, FALSE, @3.first_line, @3.ppline, @3.first_column, (@7.last_column - 1), NULL, in_static_expr );
            tmp = db_create_expression( $8, tmp, EXP_OP_DLY_OP, FALSE, @3.first_line, @3.ppline, @3.first_column, (@8.last_column - 1), NULL, in_static_expr );
            tmp = db_create_expression( tmp, $1, EXP_OP_DLY_ASSIGN, FALSE, @1.first_line, @1.ppline, @1.first_column, (@8.last_column - 1), NULL, in_static_expr );
            $$ = db_create_statement( tmp );
          } Catch_anonymous {
            error_count++;
            $$ = NULL;
  ...
  | lpvalue K_LE K_repeat '(' expression ')' event_control expression ';'
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) && ($8 != NULL) ) {
          Try {
            expression* tmp = db_create_expression( $8, $1, EXP_OP_NASSIGN, FALSE, @1.first_line, @1.ppline, @1.first_column, (@8.last_column - 1), NULL, in_static_expr );
            $$ = db_create_statement( tmp );
          } Catch_anonymous {
            expression_dealloc( $1, FALSE );
            expression_dealloc( $8, FALSE );
    ...
    statement_or_null dec_block_depth
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($3 != NULL) ) {
          expression* exp = NULL;
          Try {
            exp = db_create_expression( $3, NULL, EXP_OP_WAIT, FALSE, @1.first_line, @1.ppline, @1.first_column, (@4.last_column - 1), NULL, in_static_expr );
          } Catch_anonymous {
            error_count++;
          }
          $$ = db_create_statement( exp );
  ...
  | S_allow '(' ignore_more expression_systask_list ignore_less ')' ';'
    {
      if( parse_mode ) {
        if( ignore_mode == 0 ) {
          Try {
            $$ = db_create_statement( db_create_expression( NULL, NULL, EXP_OP_NOOP, FALSE, 0, 0, 0, 0, NULL, in_static_expr ) );
          } Catch_anonymous {
            error_count++;
            $$ = NULL;
          }
  ...
  | S_finish '(' ignore_more expression_systask_list ignore_less ')' ';'
    {
      if( parse_mode ) {
        if( ignore_mode == 0 ) {
          Try {
            $$ = db_create_statement( db_create_expression( NULL, NULL, EXP_OP_SFINISH, FALSE, 0, 0, 0, 0, NULL, in_static_expr ) );
          } Catch_anonymous {
            error_count++;
            $$ = NULL;
          }
  ...
  | S_stop '(' ignore_more expression_systask_list ignore_less ')' ';'
    {
      if( parse_mode ) {
        if( ignore_mode == 0 ) {
          Try {
            $$ = db_create_statement( db_create_expression( NULL, NULL, EXP_OP_SSTOP, FALSE, 0, 0, 0, 0, NULL, in_static_expr ) );
          } Catch_anonymous {
            error_count++;
            $$ = NULL;
          }
  ...
  | S_srandom '(' expression_systask_list ')' ';'
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($3 != NULL) ) {
          Try {
            $$ = db_create_statement( db_create_expression( NULL, $3, EXP_OP_SSRANDOM, FALSE, @1.first_line, @1.ppline, @1.first_column, (@4.last_column - 1), NULL, in_static_expr ) );
          } Catch_anonymous {
            expression_dealloc( $3, FALSE );
            error_count++;
            $$ = NULL;
  ...
  | identifier '(' expression_port_list ')' ';'
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) && ($3 != NULL) ) {
          Try {
            expression* exp = db_create_expression( NULL, $3, EXP_OP_TASK_CALL, FALSE, @1.first_line, @1.ppline, @1.first_column, (@4.last_column - 1), $1, in_static_expr );
            $$ = db_create_statement( exp );
          } Catch_anonymous {
            error_count++;
            $$ = NULL;
  ...
  | identifier ';'
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) ) {
          Try {
            expression* exp = db_create_expression( NULL, NULL, EXP_OP_TASK_CALL, FALSE, @1.first_line, @1.ppline, @1.first_column, (@1.last_column - 1), $1, in_static_expr );
            $$ = db_create_statement( exp );
          } Catch_anonymous {
            error_count++;
            $$ = NULL;
  ...
  | K_assert ';'
    {
      if( parse_mode ) {
        ...
        statement*  stmt;
        if( ignore_mode == 0 ) {
          exp  = db_create_expression( NULL, NULL, EXP_OP_NOOP, lhs_mode, 0, 0, 0, 0, NULL, in_static_expr );
          stmt = db_create_statement( exp );
          $$   = stmt;
        }
      } else {
  ...
  | IDENTIFIER ':' K_assert ';'
    {
      if( parse_mode ) {
        if( ignore_mode == 0 ) {
          Try {
            expression* exp = db_create_expression( NULL, NULL, EXP_OP_NOOP, lhs_mode, 0, 0, 0, 0, NULL, in_static_expr );
            $$ = db_create_statement( exp );
          } Catch_anonymous {
            error_count++;
            $$ = NULL;
      ...
      if( parse_mode ) {
        ...
        if( ignore_mode == 0 ) {
          if( $4 != NULL ) {
            ...
            statement*  stmt;
            Try {
              expr = db_create_expression( NULL, NULL, EXP_OP_JOIN, FALSE, @4.first_line, @4.ppline, @4.first_column, (@4.last_column - 1), NULL, in_static_expr );
            } Catch_anonymous {
              error_count++;
            }
...
statement_list
      ...
      if( parse_mode ) {
        if( ignore_mode == 0 ) {
          if( $1 == NULL ) {
            ...
            statement* stmt = db_create_statement( db_create_expression( NULL, NULL, EXP_OP_NOOP, FALSE, @2.first_line, @2.ppline, @2.first_column, (@2.last_column - 1), NULL, in_static_expr ) );
            if( !db_statement_connect( $1, stmt ) ) {
              db_remove_statement( stmt );
            }
            $$ = $1;
  ...
  | ';'
    {
      if( parse_mode ) {
        $$ = db_create_statement( db_create_expression( NULL, NULL, EXP_OP_NOOP, FALSE, @1.first_line, @1.ppline, @1.first_column, (@1.last_column - 1), NULL, in_static_expr ) );
      } else {
        generator_flush_work_code;
        $$ = NULL;
      }
  ...
  : identifier
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) ) {
          Try {
            $$ = db_create_expression( NULL, NULL, EXP_OP_SIG, TRUE, @1.first_line, @1.ppline, @1.first_column, (@1.last_column - 1), $1, in_static_expr );
          } Catch_anonymous {
            error_count++;
            $$ = NULL;
          }
  ...
  | '{' start_lhs expression_list end_lhs '}'
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($3 != NULL) ) {
          Try {
            $$ = db_create_expression( $3, NULL, EXP_OP_CONCAT, TRUE, @1.first_line, @1.ppline, @1.first_column, (@5.last_column - 1), NULL, in_static_expr );
          } Catch_anonymous {
            error_count++;
            $$ = NULL;
          }
  ...
  : '#' delay_value_simple
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($2 != NULL) ) {
          Try {
            $$ = db_create_expression( $2, NULL, EXP_OP_DELAY, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@2.last_column - 1), NULL, in_static_expr );
          } Catch_anonymous {
            expression_dealloc( $2, FALSE );
            error_count++;
            $$ = NULL;
  ...
  | '#' '(' delay_value ')'
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($3 != NULL) ) {
          Try {
            $$ = db_create_expression( $3, NULL, EXP_OP_DELAY, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@4.last_column - 1), NULL, in_static_expr );
          } Catch_anonymous {
            expression_dealloc( $3, FALSE );
            error_count++;
            $$ = NULL;
  ...
  | '#' '(' delay_value ',' delay_value ')'
    {
      if( parse_mode ) {
        ...
        if( (ignore_mode == 0) && ($3 != NULL) ) {
          Try {
            $$ = db_create_expression( $3, NULL, EXP_OP_DELAY, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@6.last_column - 1), NULL, in_static_expr );
          } Catch_anonymous {
            expression_dealloc( $3, FALSE );
            error_count++;
            $$ = NULL;
  ...
  | '#' '(' delay_value ',' delay_value ',' delay_value ')'
    {
      if( parse_mode ) {
        ...
        if( ignore_mode == 0 ) {
          Try {
            $$ = db_create_expression( $5, NULL, EXP_OP_DELAY, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@8.last_column - 1), NULL, in_static_expr );
          } Catch_anonymous {
            expression_dealloc( $5, FALSE );
            error_count++;
            $$ = NULL;
  ...
  : lavalue '=' expression
    {
      if( parse_mode ) {
        if( ($1 != NULL) && ($3 != NULL) && (info_suppl.part.excl_assign == 0) ) {
          ...
          statement*  stmt;
          Try {
            tmp = db_create_expression( $3, $1, EXP_OP_ASSIGN, FALSE, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
          } Catch_anonymous {
            error_count++;
          }
        ...
        if( ignore_mode == 0 ) {
          if( !parser_check_generation( GENERATION_2001 ) ) {
            ...
            if( $3 != NULL ) {
              ...
              statement*  stmt;
              Try {
                exp = db_create_expression( NULL, NULL, EXP_OP_SIG, TRUE, @1.first_line, @1.ppline, @1.first_column, (@1.last_column - 1), $1, in_static_expr );
                exp = db_create_expression( $3, exp, EXP_OP_RASSIGN, FALSE, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
              } Catch_anonymous {
                error_count++;
              }
      ...
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) ) {
          ...
          if( (info_suppl.part.excl_assign == 0) && ($3 != NULL) ) {
            ...
            statement*  stmt;
            Try {
              tmp = db_create_expression( NULL, NULL, EXP_OP_SIG, TRUE, @1.first_line, @1.ppline, @1.first_column, (@1.last_column - 1), $1, in_static_expr );
              tmp = db_create_expression( $3, tmp, EXP_OP_DASSIGN, FALSE, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
            } Catch_anonymous {
              error_count++;
            }
            if( (stmt = db_create_statement( tmp )) != NULL ) {
      ...
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($2 != NULL) ) {
          ...
          if( (info_suppl.part.excl_assign == 0) && ($4 != NULL) ) {
            ...
            Try {
              tmp = db_create_expression( NULL, NULL, EXP_OP_SIG, TRUE, @2.first_line, @2.ppline, @2.first_column, (@2.last_column - 1), $2, in_static_expr );
              tmp = db_create_expression( $4, tmp, EXP_OP_DASSIGN, FALSE, @2.first_line, @2.ppline, @2.first_column, (@4.last_column - 1), NULL, in_static_expr );
            } Catch_anonymous {
              error_count++;
            }
            if( (stmt = db_create_statement( tmp )) != NULL ) {
  ...
  : '@' IDENTIFIER
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($2 != NULL) ) {
          Try {
            $$ = db_create_expression( NULL, NULL, EXP_OP_SIG, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@2.last_column - 1), $2, in_static_expr );
          } Catch_anonymous {
            error_count++;
            $$ = NULL;
          }
  ...
  | event_expression_list K_or event_expression
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) && ($3 != NULL) ) {
          Try {
            $$ = db_create_expression( $3, $1, EXP_OP_EOR, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
          } Catch_anonymous {
            error_count++;
            $$ = NULL;
          }
  ...
  : K_posedge expression
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($2 != NULL) ) {
          Try {
            $$ = db_create_expression( $2, NULL, EXP_OP_PEDGE, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@2.last_column - 1), NULL, in_static_expr );
          } Catch_anonymous {
            expression_dealloc( $2, FALSE );
            error_count++;
            $$ = NULL;
  ...
  | K_negedge expression
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($2 != NULL) ) {
          Try {
            $$ = db_create_expression( $2, NULL, EXP_OP_NEDGE, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@2.last_column - 1), NULL, in_static_expr );
          } Catch_anonymous {
            expression_dealloc( $2, FALSE );
            error_count++;
            $$ = NULL;
  ...
  | expression
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL ) ) {
          Try {
            $$ = db_create_expression( $1, NULL, EXP_OP_AEDGE, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@1.last_column - 1), NULL, in_static_expr );
          } Catch_anonymous {
            expression_dealloc( $1, FALSE );
            error_count++;
            $$ = NULL;
  ...
  : '[' expression ']'
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($2 != NULL) ) {
          Try {
            $$ = db_create_expression( NULL, $2, EXP_OP_SBIT_SEL, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@3.last_column - 1), NULL, in_static_expr );
          } Catch_anonymous {
            error_count++;
          }
        } else {
  ...
  | '[' expression ':' expression ']'
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($2 != NULL) && ($4 != NULL) ) {
          Try {
            $$ = db_create_expression( $4, $2, EXP_OP_MBIT_SEL, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@5.last_column - 1), NULL, in_static_expr );
          } Catch_anonymous {
            error_count++;
          }
        } else {
          ...
          if( (ignore_mode == 0) && ($2 != NULL) && ($4 != NULL) ) {
            if( $4->exp == NULL ) {
              Try {
                ...
                $$ = db_create_expression( tmp, $2, EXP_OP_MBIT_POS, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@5.last_column - 1), NULL, in_static_expr );
              } Catch_anonymous {
                error_count++;
                $$ = NULL;
              }
              ...
              Try {
                $$ = db_create_expression( $4->exp, $2, EXP_OP_MBIT_POS, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@5.last_column - 1), NULL, in_static_expr );
              } Catch_anonymous {
                error_count++;
                $$ = NULL;
              }
      ...
      if( parse_mode ) {
        ...
        if( !parser_check_generation( GENERATION_2001 ) ) {
          ...
          if( (ignore_mode == 0) && ($2 != NULL) && ($4 != NULL) ) {
            if( $4->exp == NULL ) {
              Try {
                tmp = db_create_expression( NULL, NULL, EXP_OP_STATIC, FALSE, @1.first_line, @1.ppline, @1.first_column, (@1.last_column - 1), NULL, in_static_expr );
              } Catch_anonymous {
                error_count++;
              }
              vector_dealloc( tmp->value );
              ...
              (void)vector_from_int( tmp->value, $4->num );
              Try {
                tmp = db_create_expression( tmp, $2, EXP_OP_MBIT_NEG, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@5.last_column - 1), NULL, in_static_expr );
              } Catch_anonymous {
                error_count++;
              }
            } else {
              Try {
                tmp = db_create_expression( $4->exp, $2, EXP_OP_MBIT_NEG, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@5.last_column - 1), NULL, in_static_expr );
              } Catch_anonymous {
                error_count++;
              }
            }
  ...
  : index_expr single_index_expr
    {
      if( parse_mode ) {
        if( (ignore_mode == 0) && ($1 != NULL) && ($2 != NULL) ) {
          Try {
            $$ = db_create_expression( $2, $1, EXP_OP_DIM, lhs_mode, @1.first_line, @1.ppline, @1.first_column, (@2.last_column - 1), NULL, in_static_expr );
          } Catch_anonymous {
            error_count++;
          }
        } else {
