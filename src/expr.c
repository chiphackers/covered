...
const exp_info exp_op_info[EXP_OP_NUM] = { {"STATIC",         "",        expression_op_func__null,      {0, 1, 0, 1, 0, 0} },
                                           ...
                                           {"PEDGE",          "posedge", expression_op_func__pedge,     {1, 0, 0, 0, 1, 1} },
                                           {"NEDGE",          "negedge", expression_op_func__nedge,     {1, 0, 0, 0, 1, 1} },
                                           {"AEDGE",          "anyedge", expression_op_func__aedge,     {1, 0, 0, 0, 1, 1} },
                                           {"LAST",           "",        expression_op_func__null,      {0, 0, 0, 1, 0, 0} },
                                           {"EOR",            "or",      expression_op_func__eor,       {1, 0, 0, 1, 0, 1} },
                                           {"DELAY",          "#",       expression_op_func__delay,     {1, 0, 0, 0, 0, 1} },
                                           {"CASE",           "case",    expression_op_func__case,      {0, 0, 0, 1, 0, 0} },
                                           {"CASEX",          "casex",   expression_op_func__casex,     {0, 0, 0, 1, 0, 0} },
                                           {"CASEZ",          "casez",   expression_op_func__casez,     {0, 0, 0, 1, 0, 0} },
